/*! For license information please see chunk.163.3197ac51d26339ae73a6.js.LICENSE.txt */
(globalThis.webpackChunk_ember_auto_import_=globalThis.webpackChunk_ember_auto_import_||[]).push([[163],{35:(e,t,r)=>{"use strict"
r.r(t),r.d(t,{IS_DESCRIPTOR:()=>n,createDescriptor:()=>d,isDescriptor:()=>a,lookupDescriptorData:()=>u,registerDescriptorData:()=>i,resolveDOMElement:()=>s,resolveDOMElements:()=>l,resolveDescription:()=>c})
const n="__dom_element_descriptor_is_descriptor__"
function a(e){return Boolean("object"==typeof e&&e&&n in e)}function o(){const e=window
...
{let e=t.element
return e?[e]:[]}}function c(e){let t=a(e)?u(e):e
return t?.description}function d(e){let t={[n]:!0}
return i(t,e),t}},14843:(e,t,r)=>{"use strict"
r.r(t),r.d(t,{TestLoader:()=>a,loadTests:()=>i})
var n=r(34116)
class a{static load(){(new a).loadModules()}constructor(){this._didLogMissingUnsee=!1}shouldLoadModule(e){return e.match(/[-_]test$/)}listModules(){return Object.keys(requirejs.entries)}listTestModules(){let e,t=this.listModules(),r=[]
for(let n=0;n<t.length;n++)e=t[n],this.shouldLoadModule(e)&&r.push(e)
return r}loadModules(){let e,t=this.listTestModules()
for(let r=0;r<t.length;r++)e=t[r],this.require(e),this.unsee(e)}require(e){try{window.require(e)}catch(t){this.moduleLoadFailure(e,t)}}unsee(e){"function"==typeof window.require.unsee?window.require.unsee(e):this._didLogMissingUnsee||(this._didLogMissingUnsee=!0,"undefined"!=typeof console&&console.warn("unable to require.unsee, please upgrade loader.js to >= v3.3.0"))}moduleLoadFailure(e,t){o.push(t),n.module("TestLoader Failures"),n.test(e+": could not be loaded",function(){throw t})}}let o=[]
function i(){(new a).loadModules()}n.done(function(){let e=o.length
try{if(0!==e)throw 1===e?o[0]:new Error("\n"+o.join("\n"))}finally{o=[]}})},34116:(e,t,r)=>{var n
...
function N(e){var t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],r=t&&S("array",e)?[]:{}
for(var n in e)if(x.call(e,n)){var a=e[n]
r[n]=a===Object(a)?N(a,t):a}return r}function B(e,t){if(e!==Object(e))return e
var r={}
...
return r instanceof e||(r=n.assert),r.test.pushResult(t)}},{key:"ok",value:function(e,t){t||(t=e?"okay":"failed, expected argument to be truthy, was: ".concat(te.parse(e))),this.pushResult({result:!!e,actual:e,expected:!0,message:t})}},{key:"notOk",value:function(e,t){t||(t=e?"failed, expected argument to be falsy, was: ".concat(te.parse(e)):"okay"),this.pushResult({result:!e,actual:e,expected:!1,message:t})}},{key:"true",value:function(e,t){this.pushResult({result:!0===e,actual:e,expected:!0,message:t})}},{key:"false",value:function(e,t){this.pushResult({result:!1===e,actual:e,expected:!1,message:t})}},{key:"equal",value:function(e,t,r){this.pushResult({result:t==e,actual:e,expected:t,message:r})}},{key:"notEqual",value:function(e,t,r){this.pushResult({result:t!=e,actual:e,expected:t,message:r,negative:!0})}},{key:"propEqual",value:function(e,t,r){e=N(e),t=N(t),this.pushResult({result:W(e,t),actual:e,expected:t,message:r})}},{key:"notPropEqual",value:function(e,t,r){e=N(e),t=N(t),this.pushResult({result:!W(e,t),actual:e,expected:t,message:r,negative:!0})}},{key:"propContains",value:function(e,t,r){e=B(e,t),t=N(t,!1),this.pushResult({result:W(e,t),actual:e,expected:t,message:r})}},{key:"notPropContains",value:function(e,t,r){e=B(e,t),t=N(t),this.pushResult({result:!W(e,t),actual:e,expected:t,message:r,negative:!0})}},{key:"deepEqual",value:function(e,t,r){this.pushResult({result:W(e,t),actual:e,expected:t,message:r})}},{key:"notDeepEqual",value:function(e,t,r){this.pushResult({result:!W(e,t),actual:e,expected:t,message:r,negative:!0})}},{key:"strictEqual",value:function(e,t,r){this.pushResult({result:t===e,actual:e,expected:t,message:r})}},{key:"notStrictEqual",value:function(e,t,r){this.pushResult({result:t!==e,actual:e,expected:t,message:r,negative:!0})}},{key:"throws",value:function(t,r,n){var a=s(De(r,n,"throws"),2)
r=a[0],n=a[1]
...
T(e,be)&&(Y._event_memory[e]=t)}var Fe="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{}
...
else try{e(this)}catch(e){this.pushFailure("Died on test #"+(this.assertions.length+1)+": "+(e.message||e)+"\n"+this.stack,fe(e,0)),Ne(),Y.blocking&&Pe(this)}function e(e){var t
t=e.withData?e.callback.call(e.testEnvironment,e.assert,e.data):e.callback.call(e.testEnvironment,e.assert),e.resolvePromise(t),0===e.timeout&&e.pauses.size>0&&Te("Test did not finish synchronously even though assert.timeout( 0 ) was used.",he(2))}},after:function(){!function(){var e=Y.pollution
Ne()
var t=k(Y.pollution,e)
t.length>0&&Te("Introduced global variable(s): "+t.join(", "))
var r=k(e,Y.pollution)
r.length>0&&Te("Deleted global variable(s): "+r.join(", "))}()},queueGlobalHook:function(e,t){var r=this
...
r.pushFailure(n,fe(e,0)),Ne(),Pe(r)})}}},valid:function(){if(this.callback&&this.callback.validTest)return!0
if(!function e(t,r){return!r||!r.length||T(t.moduleId,r)||t.parentModule&&e(t.parentModule,r)}(this.module,Y.moduleId))return!1
if(Y.testId&&Y.testId.length&&!T(this.testId,Y.testId))return!1
...
T(t,n)||(n.push(t),void 0!==Y._event_memory[e]&&t(Y._event_memory[e]))},onError:function(e){if(re.warn("QUnit.onError is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),Y.current&&Y.current.ignoreGlobalErrors)return!0
var t=new Error(e.message)
return t.stack=e.stacktrace||e.fileName+":"+e.lineNumber,st(t),!1},onUncaughtException:st,pushFailure:Te,assert:me.prototype,module:ce,test:Se,todo:Se.todo,skip:Se.skip,only:Se.only,start:function(e){if(Y.current)throw new Error("QUnit.start cannot be called inside a test context.")
var t=ft
...
return T.total=p+m,T},goAsync:function(t,r,n){var o=!1,i=new Promise(function(i,u){if("farzher"==t)return i([{target:"farzher was here (^-^*)/",score:0,indexes:[0,1,2,3,4,5,6],obj:r?r[0]:null}])
if(!t)return i(a)
...
for(var x=r[D],A=new Array(C),k=C-1;k>=0;--k)(B=l(x,N=E[k]))?(c(B)||(B=h.getPrepared(B)),A[k]=b(t,B,f)):A[k]=null
A.obj=x
var T=p(A)
null!==T&&(T<g||(A.score=T,y<v?(m.add(A),++y):(++F,T>m.peek().score&&m.replaceTop(A))))}else if(n&&n.key)for(var N=n.key;D>=0;--D){if(D%1e3==0&&Date.now()-d>=10)return void(e?setImmediate(w):setTimeout(w));(B=l(x=r[D],N))&&(c(B)||(B=h.getPrepared(B)),null!==(R=b(t,B,f))&&(R.score<g||(R={target:R.target,_targetLowerCodes:null,_nextBeginningIndexes:null,score:R.score,indexes:R.indexes,obj:x},y<v?(m.add(R),++y):(++F,R.score>m.peek().score&&m.replaceTop(R)))))}else for(;D>=0;--D){if(D%1e3==0&&Date.now()-d>=10)return void(e?setImmediate(w):setTimeout(w))
...
o.selectedMap.forEach(function(e,r){t+=N(r,e,!0)})
for(var r=0;r<e.length;r++){var n=e[r].obj
o.selectedMap.has(n.moduleId)||(t+=N(n.moduleId,n.name,!1))}return t}(""===e?o.options.slice(0,20).map(function(e){return{obj:e}}):bt.go(e,o.options,{limit:20,key:"name",allowTypo:!0}))}(i.value)})}function k(e){var t=e&&e.target||null
...
return t.value=c(t.value),T(),e&&e.preventDefault&&e.preventDefault(),!1}function A(){var r,n=this,a={}
...
return r.protocol+"//"+r.host+r.pathname+t.slice(0,-1)}function T(){var e=E("qunit-filter-input").value
v.location=k({filter:""===e?void 0:e,moduleId:l(o.selectedMap.keys()),module:void 0,testId:void 0})}function N(e,t,r){return'<li><label class="clickable'+(r?" checked":"")+'"><input type="checkbox" value="'+I(e)+'"'+(r?' checked="checked"':"")+" />"+I(t)+"</label></li>"}function B(e,t,r){var n=E("qunit-tests")
...
return t&&(r="<span class='module-name'>"+I(t)+"</span>: "),r+"<span class='test-name'>"+I(e)+"</span>"}function O(e){return[e.completed," / ",e.defined," tests completed.<br />"].join("")}function P(e){return e.replace(/<\/?[^>]+(>|$)/g,"").replace(/&quot;/g,"").replace(/\s+/g,"")}}()}()},46470:(e,t,r)=>{"use strict"
r.r(t),r.d(t,{CI:()=>a,DEBUG:()=>n})
const n=!1,a=!1},62442:function(e,t){!function t(r){var n=r,a=r.document
...
function k(e,t,r){return t=N(t),function(e,t){if(t&&("object"==o(t)||"function"==typeof t))return t
if(void 0!==t)throw new TypeError("Derived constructors may only return object or undefined")
return function(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called")
return e}(e)}(e,T()?Reflect.construct(t,r||[],N(e).constructor):t.apply(e,r))}function T(){try{var e=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){}))}catch(e){}return(T=function(){return!!e})()}function N(e){return N=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(e){return e.__proto__||Object.getPrototypeOf(e)},N(e)}function B(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function")
...
for(var r=0,n=Array(t);r<t;r++)n[r]=e[r]
return n}function o(e){return o="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},o(e)}!function(e,t,N,O,G,X,Z,J,ee,te,re){var ne=Object.create,ae=Object.defineProperty,oe=Object.getPrototypeOf,ie=Object.prototype.hasOwnProperty,ue=Object.getOwnPropertyNames,se=Object.getOwnPropertyDescriptor,le=function(e,t){return function(){return t||e((t={exports:{}}).exports,t),t.exports}},ce=function(e,t){for(var r in t)ae(e,r,{get:t[r],enumerable:!0})},de=function(e){return function(e,t,r){if(t&&"object"===o(t)||"function"==typeof t){var n,a=Q(ue(t))
...
t.exports=Te()()?Object.keys:Ne()}),Re=le(function(e,t){"use strict"
...
return m=!1!==t?t:isNaN(e.length)?1:e.length,o.normalizer&&(E=u(o.normalizer),D=E.get,g=E.set,v=E.delete,b=E.clear),null!=o.resolvers&&(T=i(o.resolvers)),k=D?n(function(t){var n,a,o=arguments
if(T&&(o=T(o)),null!==(n=D(o))&&hasOwnProperty.call(N,n))return C&&h.emit("get",n,o,this),N[n]
if(a=1===o.length?l.call(e,this,o[0]):s.call(e,this,o),null===n){if(null!==(n=D(o)))throw r("Circular invocation","CIRCULAR_INVOCATION")
n=g(o)}else if(hasOwnProperty.call(N,n))throw r("Circular invocation","CIRCULAR_INVOCATION")
return N[n]=a,x&&h.emit("set",n,null,a),a},m):0===t?function(){var t
if(hasOwnProperty.call(N,"data"))return C&&h.emit("get","data",arguments,this),N.data
if(t=arguments.length?s.call(e,this,arguments):l.call(e,this),hasOwnProperty.call(N,"data"))throw r("Circular invocation","CIRCULAR_INVOCATION")
return N.data=t,x&&h.emit("set","data",null,t),t}:function(t){var n,a,o=arguments
if(T&&(o=T(arguments)),a=String(o[0]),hasOwnProperty.call(N,a))return C&&h.emit("get",a,o,this),N[a]
if(n=1===o.length?l.call(e,this,o[0]):s.call(e,this,o),hasOwnProperty.call(N,a))throw r("Circular invocation","CIRCULAR_INVOCATION")
return N[a]=n,x&&h.emit("set",a,null,n),n},h={original:e,memoized:k,profileName:o.profileName,get:function(e){return T&&(e=T(e)),D?D(e):String(e[0])},has:function(e){return hasOwnProperty.call(N,e)},delete:function(e){var t
hasOwnProperty.call(N,e)&&(v&&v(e),t=N[e],delete N[e],A&&h.emit("delete",e,t))},clear:function(){var e=N
b&&b(),N=c(null),h.emit("clear",e)},on:function(e,t){return"get"===e?C=!0:"set"===e?x=!0:"delete"===e&&(A=!0),p.call(this,e,t)},emit:f,updateEnv:function(){e=h.original}},y=D?n(function(e){var t,r=arguments
T&&(r=T(r)),null!==(t=D(r))&&h.delete(t)},m):0===t?function(){return h.delete("data")}:function(e){return T&&(e=T(arguments)[0]),h.delete(e)},F=n(function(){var e,r=arguments
return 0===t?N.data:(T&&(r=T(r)),e=D?D(r):String(r[0]),N[e])}),w=n(function(){var e,r=arguments
return 0===t?h.has("data"):(T&&(r=T(r)),null!==(e=D?D(r):String(r[0]))&&h.has(e))}),d(k,{__memoized__:a(!0),delete:a(y),clear:a(h.clear),_get:a(F),_has:a(w)}),h}}),ht=le(function(e,t){"use strict"
...
return r.call(arguments,function(e){t[e]=!0}),t}}),Tt=le(function(e,t){"use strict"
...
function B(t,r,n){r.constructor===t.constructor&&n===E&&r.constructor.resolve===C?function(e,t){t._state===T?S(e,t._result):t._state===N?O(e,t._result):M(t,void 0,function(t){return R(e,t)},function(t){return O(e,t)})}(t,r):void 0===n?S(t,r):e(n)?function(e,t,r){l(function(e){var n=!1,a=function(r,a){try{r.call(a,function(r){n||(n=!0,t!==r?R(e,r):S(e,r))},function(t){n||(n=!0,O(e,t))})}catch(e){return e}}(r,t,e._label)
...
try{r=t.then}catch(t){return void O(e,t)}B(e,t,r)}var n,a}function _(e){e._onerror&&e._onerror(e._result),I(e)}function S(e,t){e._state===k&&(e._result=t,e._state=T,0!==e._subscribers.length&&l(I,e))}function O(e,t){e._state===k&&(e._state=N,e._result=t,l(_,e))}function M(e,t,r,n){var a=e._subscribers,o=a.length
e._onerror=null,a[o]=t,a[o+T]=r,a[o+N]=n,0===o&&e._state&&l(I,e)}function I(e){var t=e._subscribers,r=e._state
...
r._state!==k||(o&&s?R(r,i):!1===s?O(r,u):t===T?S(r,i):t===N&&O(r,i))}var j=0
...
n._state===k&&(this._remaining--,e===N?O(n,r):this._result[t]=r),0===this._remaining&&S(n,this._result)},e.prototype._willSettleAt=function(e,t){var r=this
...
return e<<r>>>r}function v(e){return[255&e]}function b(e){return D(e[0],8)}function y(e){return[255&e]}function F(e){return g(e[0],8)}function w(e){return[(e=d(Number(e)))<0?0:e>255?255:255&e]}function E(e){return[e>>8&255,255&e]}function C(e){return D(e[0]<<8|e[1],16)}function x(e){return[e>>8&255,255&e]}function A(e){return g(e[0]<<8|e[1],16)}function k(e){return[e>>24&255,e>>16&255,e>>8&255,255&e]}function T(e){return D(e[0]<<24|e[1]<<16|e[2]<<8|e[3],32)}function N(e){return[e>>24&255,e>>16&255,e>>8&255,255&e]}function B(e){return g(e[0]<<24|e[1]<<16|e[2]<<8|e[3],32)}function R(e,t,r){var n,o,d,p,f,h,m,D=(1<<t-1)-1
...
t.exports=function(e,t){try{n(r,e,{value:t,configurable:!0,writable:!0})}catch(n){r[e]=t}return t}}),Tr=le(function(e,t){"use strict"
var r=Kt(),n=kr(),a="__core-js_shared__",o=r[a]||n(a,{})
t.exports=o}),Nr=le(function(e,t){"use strict"
var r=Ar(),n=Tr();(t.exports=function(e,t){return n[e]||(n[e]=void 0!==t?t:{})})("versions",[]).push({version:"3.33.0",mode:r?"pure":"global",copyright:"© 2014-2023 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.33.0/LICENSE",source:"https://github.com/zloirock/core-js"})}),Br=le(function(e,t){"use strict"
var r=dr(),n=Object
...
var r=Kt(),n=Nr(),a=Rr(),o=_r(),i=br(),u=yr(),s=r.Symbol,l=n("wks"),c=u?s.for||s:s&&s.withoutSetter||o
...
t.exports=function(e,t){var n,h,m,D,g,v,b,y,F,w=e.target,E=e.global,C=e.stat,x=e.proto,A=E?r:C?r[w]:(r[w]||{}).prototype,k=E?l:l[w]||d(l,w,{})[w],T=k.prototype
for(D in t)h=!(n=s(E?D:w+(C?".":"#")+D,e.forced))&&A&&p(A,D),v=k[D],h&&(b=e.dontCallGetSet?(F=u(A,D))&&F.value:A[D]),g=h&&b?b:t[D],h&&o(v)==o(g)||(y=e.bind&&h?c(g,r):e.wrap&&h?f(g):x&&i(g)?a(g):g,(e.sham||g&&g.sham||v&&v.sham)&&d(y,"sham",!0),d(k,D,y),x&&(p(l,m=w+"Prototype")||d(l,m,{}),d(l[m],D,g),e.real&&T&&(n||!T[D])&&d(T,D,g)))}}),Gr=le(function(){"use strict"
...
var r,n,a,o,i,u=bn(),s=Kt(),l=fr(),c=Hr(),d=Rr(),p=Tr(),f=Kr(),h=on(),m="Object already initialized",D=s.TypeError,g=s.WeakMap
...
var r=mn(),n=Dn()
t.exports=r?{}.toString:function(){return"[object "+n(this)+"]"}}),Tn=le(function(e,t){"use strict"
var r=mn(),n=Ur().f,a=Hr(),o=Rr(),i=kn(),u=Sr()("toStringTag")
t.exports=function(e,t,s,l){if(e){var c=s?e:e.prototype
o(c,u)||n(c,u,{configurable:!0,value:t}),l&&!r&&a(c,"toString",i)}}}),Nn=le(function(e,t){"use strict"
t.exports={}}),Bn=le(function(e,t){"use strict"
var r=An().IteratorPrototype,n=Cn(),a=sr(),o=Tn(),i=Nn(),u=function(){return this}
...
var r=$r(),n=ir(),a=Ar(),o=Fn(),i=ar(),u=Bn(),s=Zr(),l=Sn(),c=Tn(),d=Hr(),p=xn(),f=Sr(),h=Nn(),m=An(),D=o.PROPER,g=o.CONFIGURABLE,v=m.IteratorPrototype,b=m.BUGGY_SAFARI_ITERATORS,y=f("iterator"),F="keys",w="values",E="entries",C=function(){return this}
t.exports=function(e,t,o,f,m,x,A){u(o,t,f)
var k,T,N,B=function(e){if(e===m&&M)return M
...
if(I&&(k=s(I.call(new e)))!==Object.prototype&&k.next&&(a||s(k)===v||(l?l(k,v):i(k[y])||p(k,y,C)),c(k,R,!0,!0),a&&(h[R]=C)),D&&m===w&&O&&O.name!==w&&(!a&&g?d(S,"name",w):(_=!0,M=function(){return n(O,this)})),m)if(T={values:B(w),keys:x?M:B(F),entries:B(E)},A)for(N in T)(b||_||!(N in S))&&p(S,N,T[N])
else r({target:t,proto:!0,forced:b||_},T)
return a&&!A||S[y]===M||p(S,y,M,{name:m}),h[t]=M,T}}),Mn=le(function(e,t){"use strict"
...
var r=Sr(),n=Nn(),a=r("iterator"),o=Array.prototype
t.exports=function(e){return void 0!==e&&(n.Array===e||o[a]===e)}}),Ln=le(function(e,t){"use strict"
var r=er(),n=ar(),a=Tr(),o=r(Function.toString)
...
var r=Dn(),n=Cr(),a=cr(),o=Nn(),i=Sr()("iterator")
...
ce(na,{DqElement:function(){return to},aggregate:function(){return aa},aggregateChecks:function(){return ca},aggregateNodeResults:function(){return pa},aggregateResult:function(){return ha},areStylesSet:function(){return ma},assert:function(){return Da},checkHelper:function(){return ro},clone:function(){return no},closest:function(){return yo},collectResultsFromFrames:function(){return mi},contains:function(){return Di},convertSelector:function(){return go},cssParser:function(){return io},deepMerge:function(){return gi},escapeSelector:function(){return va},extendMetaData:function(){return vi},filterHtmlAttrs:function(){return fm},finalizeRuleResult:function(){return da},findBy:function(){return pi},getAllChecks:function(){return di},getAncestry:function(){return Ga},getBaseLang:function(){return Xf},getCheckMessage:function(){return ih},getCheckOption:function(){return uh},getEnvironmentData:function(){return sh},getFlattenedTree:function(){return Yf},getFrameContexts:function(){return Fh},getFriendlyUriEnd:function(){return wa},getNodeAttributes:function(){return Ea},getNodeFromTree:function(){return Za},getPreloadConfig:function(){return um},getRootNode:function(){return wi},getRule:function(){return wh},getScroll:function(){return Ch},getScrollState:function(){return Ah},getSelector:function(){return Ua},getSelectorData:function(){return Pa},getShadowSelector:function(){return Ta},getStandards:function(){return kh},getStyleSheetFactory:function(){return Nh},getXpath:function(){return Ya},injectStyle:function(){return Bh},isArrayLike:function(){return Rh},isContextObject:function(){return Oh},isContextProp:function(){return Mh},isContextSpec:function(){return Sh},isHidden:function(){return jh},isHtmlElement:function(){return qh},isLabelledFramesSelector:function(){return Ih},isLabelledShadowDomSelector:function(){return Ph},isNodeInContext:function(){return Lh},isShadowRoot:function(){return yi},isValidLang:function(){return xm},isXHTML:function(){return ka},matchAncestry:function(){return Vh},matches:function(){return uo},matchesExpression:function(){return bo},matchesSelector:function(){return Ca},memoize:function(){return Aa},mergeResults:function(){return hi},nodeLookup:function(){return Hh},nodeSerializer:function(){return ci},nodeSorter:function(){return Uh},objectHasOwn:function(){return _h},parseCrossOriginStylesheet:function(){return Wh},parseSameOriginStylesheet:function(){return $h},parseStylesheet:function(){return Gh},parseTabindex:function(){return Yh},performanceTimer:function(){return Qh},pollyfillElementsFromPoint:function(){return Kh},preload:function(){return om},preloadCssom:function(){return em},preloadMedia:function(){return am},processMessage:function(){return oh},publishMetaData:function(){return sm},querySelectorAll:function(){return cm},querySelectorAllFilter:function(){return Jh},queue:function(){return xo},respondable:function(){return ni},ruleShouldRun:function(){return pm},select:function(){return mm},sendCommandToFrame:function(){return oi},setScrollState:function(){return gm},shadowSelect:function(){return vm},shadowSelectAll:function(){return ym},shouldPreload:function(){return im},toArray:function(){return ga},tokenList:function(){return zf},uniqueArray:function(){return Xh},uuid:function(){return zo},validInputTypes:function(){return wm},validLangs:function(){return Cm}})
...
function Ta(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}
if(!t)return""
...
return r}function Ma(e,t){return e.count<t.count?-1:e.count===t.count?0:1}function Ia(e){return!Na.includes(e.name)&&-1===e.name.indexOf(":")&&(!e.value||e.value.length<Ba)}function Pa(e){for(var t={classes:{},tags:{},attributes:{}},r=(e=Array.isArray(e)?e:[e]).slice(),n=[],a=function(){var e=r.pop(),a=e.actualNode
...
return 1===a.length?n:-1!==n.indexOf(" > ")?":root"+n.substring(n.indexOf(" > ")):":root"}var Ua=Aa(function(e,t){return Ta(Va,e,t)}),Ha=Aa(function(e,t){return Array.from(e.querySelectorAll(t))})
...
a=":nth-child(".concat(o,")")}return r?$a(r)+" > "+t+a:t+a}function Ga(e,t){return Ta($a,e,t)}function Wa(e,t){var r,n
if(!e)return[]
...
return To}}for(var No="function"==typeof r.Buffer?r.Buffer:Array,Bo=[],Ro={},_o=0;_o<256;_o++)Bo[_o]=(_o+256).toString(16).substr(1),Ro[Bo[_o]]=_o
...
ce(Fi,{createGrid:function(){return yu},findElmsInContext:function(){return Ci},findNearbyElms:function(){return Nu},findUp:function(){return Ai},findUpVirtual:function(){return xi},focusDisabled:function(){return Iu},getComposedParent:function(){return Wi},getElementByReference:function(){return Lu},getElementCoordinates:function(){return Qi},getElementStack:function(){return $u},getModalDialog:function(){return Ru},getOverflowHiddenAncestors:function(){return Ni},getRootNode:function(){return Ei},getScrollOffset:function(){return Yi},getTabbableElements:function(){return Gu},getTargetRects:function(){return Ku},getTargetSize:function(){return Xu},getTextElementStack:function(){return Ml},getViewportSize:function(){return Ki},getVisibleChildTextRects:function(){return Sl},hasContent:function(){return zl},hasContentVirtual:function(){return Ll},hasLangText:function(){return Vl},idrefs:function(){return Ju},insertedIntoFocusOrder:function(){return Ul},isCurrentPageLink:function(){return qu},isFocusable:function(){return Yu},isHTML5:function(){return Wl},isHiddenForEveryone:function(){return Hi},isHiddenWithCSS:function(){return Gl},isInTabOrder:function(){return Qu},isInTextBlock:function(){return Zl},isInert:function(){return _u},isModalOpen:function(){return Jl},isMultiline:function(){return ec},isNativelyFocusable:function(){return Wu},isNode:function(){return tc},isOffscreen:function(){return Xi},isOpaque:function(){return wf},isSkipLink:function(){return Ef},isVisible:function(){return kf},isVisibleOnScreen:function(){return Ji},isVisibleToScreenReaders:function(){return Qs},isVisualContent:function(){return Pl},reduceToElementsBelowFloating:function(){return Tf},shadowElementsFromPoint:function(){return _f},urlPropsFromAttribute:function(){return If},visuallyContains:function(){return Nf},visuallyOverlaps:function(){return Pf},visuallySort:function(){return zu}})
...
var o=cm(i._tree,'img[usemap="#'.concat(va(n),'"]'))
...
return e=Hh(e).vNode,r?$i(e,a):Gi(e,a)}var $i=Aa(function(e,t){return!(!_i(e)&&(!e.actualNode||!Ui.some(function(r){return r(e,{isAncestor:t})})&&e.actualNode.isConnected))}),Gi=Aa(function(e,t){return!!$i(e,t)||!!e.parent&&Gi(e.parent,!0)}),Wi=function e(t){if(t.assignedSlot)return e(t.assignedSlot)
...
function Ji(e){return e=Hh(e).vNode,eu(e)}var eu=Aa(function(e,t){return e.actualNode&&"area"===e.props.nodeName?!zi(e,eu):!Hi(e,{skipAncestors:!0,isAncestor:t})&&(!e.actualNode||!Zi.some(function(r){return r(e,{isAncestor:t})}))&&(!e.parent||eu(e.parent,!0))})
...
return null!==o&&n.push(Cu(o,r,e)),n}function Cu(e,t,r){return{stackLevel:e,treeOrder:t,vNode:r}}function xu(e,t){for(var r=null,n=[e];t;){if(Ch(t.actualNode)){r=t
break}if(t._scrollRegionParent){r=t._scrollRegionParent
break}n.push(t),t=Za(t.actualNode.parentElement||t.actualNode.parentNode)}return n.forEach(function(e){return e._scrollRegionParent=r}),r}function Au(e,t){var r=Ni(t)
...
this.boundaries&&(e=tu(this.boundaries,e)),this.boundaries=e,Tu(this.cells,o,i,function(e,r){Tu(e,n,a,function(e,n){t(e,{row:r,col:n})})})}},{key:"getGridPositionOfRect",value:function(e){var t=e.top,n=e.right,a=e.bottom,o=e.left,i=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
...
null!==(c=e[l=s])&&void 0!==c||(e[l]=[]),n(e[s],s+e._negativeIndex)}}function Nu(e){var t,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
...
if(r&&!Di(r,e))return!0}return!1}),Ou=Aa(function(e,t){return!!Su(e,t)||!!e.parent&&Ou(e.parent,!0)}),Mu=["button","command","fieldset","keygen","optgroup","option","select","textarea","input"],Iu=function(e){var t,r=Hh(e).vNode
...
return r?Hu(r,t.boundingClientRect):[]},Gu=function(e){return cm(e,"*").filter(function(e){var t=e.isFocusable,r=Yh(e.actualNode.getAttribute("tabindex"))
return null!==r?t&&r>=0:t})},Wu=function(e){var t=Hh(e).vNode
if(!t||Iu(t))return!1
...
function Yu(e){var t=Hh(e).vNode
return!(1!==t.props.nodeType||Iu(t)||!Wu(t)&&null===Yh(t.attr("tabindex")))}function Qu(e){var t=Hh(e).vNode
return 1===t.props.nodeType&&!(Yh(t.attr("tabindex"))<=-1)&&Yu(t)}var Ku=Aa(function(e){var t=e.boundingClientRect,r=Nu(e).filter(function(t){return du(e,t)&&"none"!==t.getComputedStylePropertyValue("pointer-events")&&!function(e,t){return Di(e,t)&&!Qu(t)}(e,t)})
...
ce(Zu,{accessibleText:function(){return es},accessibleTextVirtual:function(){return Fl},autocomplete:function(){return xl},formControlValue:function(){return ll},formControlValueMethods:function(){return ul},hasUnicode:function(){return bl},isHumanInterpretable:function(){return Cl},isIconLigature:function(){return yl},isValidAutocomplete:function(){return Al},label:function(){return Bl},labelText:function(){return pl},labelVirtual:function(){return Nl},nativeElementType:function(){return Rl},nativeTextAlternative:function(){return gl},nativeTextMethods:function(){return Dl},removeUnicode:function(){return El},sanitize:function(){return vs},subtreeText:function(){return dl},titleText:function(){return $s},unsupported:function(){return Ys},visible:function(){return Tl},visibleTextNodes:function(){return _l},visibleVirtual:function(){return Xs}})
var Ju=function(e,t){e=e.actualNode||e
try{var r=Ei(e),n=[],a=e.getAttribute(t)
if(a){a=zf(a)
for(var o=0;o<a.length;o++)n.push(r.getElementById(a[o]))}return n}catch(e){throw new TypeError("Cannot resolve id references for non-DOM nodes")}},es=function(e,t){return Fl(Za(e),t)},ts=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=Hh(e).vNode
...
function rs(e){var t=Hh(e).vNode
...
function ms(e){var t=Hh(e),r=t.vNode,n=t.domNode,a=r.attr("scope"),o=r.attr("role")
...
return Object.keys(t).every(function(r){return Es(e(r),t[r])})},As=function(e,t){return e=Hh(e).vNode,xs(function(t){return e.attr(t)},t)}
function ks(e,t){return!!t(e)}var Ts=function(e,t){return Es(cs(e),t)},Ns=function(e,t){return Es(js(e),t)},Bs=function(e,t){return e=Hh(e).vNode,Es(e.props.nodeName,t)},Rs=function(e,t){return e=Hh(e).vNode,xs(function(t){return e.props[t]},t)},_s=function(e,t){return Es(Us(e),t)},Ss={hasAccessibleName:Cs,attributes:As,condition:ks,explicitRole:Ts,implicitRole:Ns,nodeName:Bs,properties:Rs,semanticRole:_s},Os=function e(t,r){return t=Hh(t).vNode,Array.isArray(r)?r.some(function(r){return e(t,r)}):"string"==typeof r?uo(t,r):Object.keys(r).every(function(e){if(!Ss[e])throw new Error('Unknown matcher type "'.concat(e,'"'))
var n=Ss[e],a=r[e]
return n(t,a)})},Ms=function(e,t){return Os(e,t)}
Ms.hasAccessibleName=Cs,Ms.attributes=As,Ms.condition=ks,Ms.explicitRole=Ts,Ms.fromDefinition=Os,Ms.fromFunction=xs,Ms.fromPrimative=Es,Ms.implicitRole=Ns,Ms.nodeName=Bs,Ms.properties=Rs,Ms.semanticRole=_s
...
return a?Ls(e,n)||a:null}function Vs(e){return ps().some(function(t){return e.hasAttr(t)})||Yu(e)}var Us=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=t.noPresentational,n=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=t.noImplicit,n=j(t,h),a=Hh(e).vNode
if(1!==a.props.nodeType)return null
var o=cs(a,n)
return o?["presentation","none"].includes(o)&&Vs(a)?r?null:zs(a,n):o:r?null:zs(a,n)}(e,j(t,m))
return r&&["presentation","none"].includes(n)?null:n},Hs=["iframe"],$s=function(e){var t=Hh(e).vNode
...
function Qs(e){return e=Hh(e).vNode,Ks(e)}var Ks=Aa(function(e,t){return!Ii(e)&&!_u(e,{skipAncestors:!0,isAncestor:t})&&(e.actualNode&&"area"===e.props.nodeName?!zi(e,Ks):!Hi(e,{skipAncestors:!0,isAncestor:t})&&(!e.parent||Ks(e.parent,!0)))}),Xs=function e(t,r,n){var a=Hh(t).vNode,o=r?Qs:Ji,i=!t.actualNode||t.actualNode&&o(t),u=a.children.map(function(t){var a=t.props,o=a.nodeType,u=a.nodeValue
...
return al.includes(t)},il=["textbox","progressbar","scrollbar","slider","spinbutton","combobox","listbox"],ul={nativeTextboxValue:function(e){var t=Hh(e).vNode
return Js(t)&&t.props.value||""},nativeSelectValue:function(e){var t=Hh(e).vNode
if(!el(t))return""
var r=cm(t,"option"),n=r.filter(function(e){return e.props.selected})
return n.length||n.push(r[0]),n.map(function(e){return Xs(e)}).join(" ")||""},ariaTextboxValue:function(e){var t=Hh(e),r=t.vNode,n=t.domNode
return tl(r)?!n||n&&!Hi(n)?Xs(r,!0):n.textContent:""},ariaListboxValue:sl,ariaComboboxValue:function(e,t){var r=Hh(e).vNode
if(!nl(r))return""
var n=Ws(r).filter(function(e){return"listbox"===Us(e)})[0]
return n?sl(n,t):""},ariaRangeValue:function(e){var t=Hh(e).vNode
if(!ol(t)||!t.hasAttr("aria-valuenow"))return""
var r=+t.attr("aria-valuenow")
return isNaN(r)?"0":String(r)}}
function sl(e,t){var r=Hh(e).vNode
if(!rl(r))return""
...
return i?(n=[].concat(q(o),[i.actualNode])).sort(Uh):n=o,n.map(function(e){return es(e,a)}).filter(function(e){return""!==e}).join(" ")},fl={submit:"Submit",image:"Submit",reset:"Reset",button:""}
...
var t=Za(e)._grid
return t?Sl(e).map(function(e){return Hu(t,e)}):[]},Il=["checkbox","img","meter","progressbar","scrollbar","radio","slider","spinbutton","textbox"],Pl=function(e){var t=Hh(e).vNode,r=i.commons.aria.getExplicitRole(t)
...
function Vl(e){return!(void 0!==e.children&&!ql(e))||(1===e.props.nodeType&&Pl(e)?!!i.commons.text.accessibleTextVirtual(e):e.children.some(function(e){return!e.attr("lang")&&Vl(e)&&!Hi(e)}))}var Ul=function(e){return Yh(e.getAttribute("tabindex"))>-1&&Yu(e)&&!Wu(e)}
function Hl(e,t){var r=Hh(e),n=r.vNode,a=r.domNode
...
function Bc(e){return Array.isArray(e)?e:Nc[e]}function Rc(e,t,r){var n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:{}
...
s[u]=r,Vc(e,i,s)}return e}var Hc=new Mc({id:"xyz-d50",name:"XYZ D50",white:"D50",base:Ic,fromBase:function(e){return Rc(Ic.white,"D50",e)},toBase:function(e){return Rc("D50",Ic.white,e)},formats:{color:{}}}),$c=216/24389,Gc=24/116,Wc=24389/27,Yc=Nc.D50,Qc=new Mc({id:"lab",name:"Lab",coords:{l:{refRange:[0,100],name:"L"},a:{refRange:[-125,125]},b:{refRange:[-125,125]}},white:Yc,base:Hc,fromBase:function(e){var t=e.map(function(e,t){return e/Yc[t]}).map(function(e){return e>$c?Math.cbrt(e):(Wc*e+16)/116})
...
var T,N=m-c,B=x-C,R=(k*=ed)-(A*=ed),_=A+k,S=Math.abs(R)
...
var H=1+.015*P*(U-=.2*Math.cos((4*O-63)*td)),$=30*Math.exp(-1*Math.pow((O-275)/25,2)),G=2*Math.sqrt(j/(j+Zc)),W=-1*Math.sin(2*$*td)*G,Y=Math.pow(N/(a*L),2)
...
e=qc(e),t=Mc.get(t)
var a=e.coords
return t!==e.space&&(a=t.from(e)),t.inGamut(a,{epsilon:n})}function ad(e){return{space:e.space,coords:e.coords.slice(),alpha:e.alpha}}function od(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=t.method,n=void 0===r?Tc.gamut_mapping:r,a=t.space,o=void 0===a?e.space:a
...
return r&&(a=od(a)),a}function ud(e){var t,r,n,a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},o=a.precision,i=void 0===o?Tc.precision:o,u=a.format,s=void 0===u?"default":u,l=a.inGamut,c=void 0===l||l,d=j(a,D),p=s
...
break}}function Cd(e){var t,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=r.space,a=void 0===n?Tc.display_space:n,o=j(r,g),i=ud(e,o)
...
return isNaN(t)||isNaN(n)?e:e+Math.pow(n-t,2)},0))}function Ad(e){return zc(e,[Ic,"y"])}function kd(e,t){Uc(e,[Ic,"y"],t)}var Td=Object.freeze({__proto__:null,getLuminance:Ad,setLuminance:kd,register:function(e){Object.defineProperty(e.prototype,"luminance",{get:function(){return Ad(this)},set:function(e){kd(this,e)}})}})
function Nd(e){return e>=.022?e:e+Math.pow(.022-e,1.414)}function Bd(e){var t=e<0?-1:1,r=Math.abs(e)
return t*Math.pow(r,2.4)}var Rd=216/24389,_d=24/116,Sd=24389/27,Od=Nc.D65,Md=new Mc({id:"lab-d65",name:"Lab D65",coords:{l:{refRange:[0,100],name:"L"},a:{refRange:[-125,125]},b:{refRange:[-125,125]}},white:Od,base:Ic,fromBase:function(e){var t=e.map(function(e,t){return e/Od[t]}).map(function(e){return e>Rd?Math.cbrt(e):(Sd*e+16)/116})
return[116*t[1]-16,500*(t[0]-t[1]),200*(t[1]-t[2])]},toBase:function(e){var t=[]
...
n=s[0],a=s[1],o=s[2]
var l=.2126729*Bd(n)+.7151522*Bd(a)+.072175*Bd(o),c=Nd(u),d=Nd(l),p=d>c
...
return B+=Math.pow(y/(i*A),2),B+=E/Math.pow(N,2),Math.sqrt(B)},deltaE2000:rd,deltaEJz:function(e,t){var r=V(op.from(e),3),n=r[0],a=r[1],o=r[2],i=V(op.from(t),3),u=i[0],s=i[1],l=i[2],c=n-u,d=a-s
...
Dc(r)&&(r={method:r})
var n=r,a=n.method,o=void 0===a?Tc.deltaE:a,i=j(n,b)
...
if(o=o?Mc.get(o):Mc.registry[Tc.interpolationSpace]||e.space,i=i?Mc.get(i):o,e=id(e,o),t=id(t,o),e=od(e),t=od(t),o.coords.h&&"angle"===o.coords.h.type){var c=r.hue=r.hue||"shorter",d=[o,"h"],p=[zc(e,d),zc(t,d)],f=p[0],h=p[1],m=function(e,t){if("raw"===e)return t
...
var Np=Object.freeze({__proto__:null,mix:xp,steps:Ap,range:kp,isRange:Tp,register:function(e){e.defineFunction("mix",xp,{returns:"color"}),e.defineFunction("range",kp,{returns:"function<color>"}),e.defineFunction("steps",Ap,{returns:"array<color>"})}}),Bp=new Mc({id:"hsl",name:"HSL",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,100],name:"Saturation"},l:{range:[0,100],name:"Lightness"}},base:gd,fromBase:function(e){var t=Math.max.apply(Math,q(e)),r=Math.min.apply(Math,q(e)),n=V(e,3),a=n[0],o=n[1],i=n[2],u=NaN,s=0,l=(r+t)/2,c=t-r
...
return function(e,t,r){if(T())return Reflect.construct.apply(null,arguments)
var n=[null]
n.push.apply(n,t)
...
return!t||e.compareDocumentPosition(t.actualNode)===e.DOCUMENT_POSITION_FOLLOWING}function Cf(){return(r.location.origin?cm(i._tree,'a[href]:not([href^="javascript:"])').find(function(e){return!qu(e.actualNode)}):cm(i._tree,'a:not([href^="#"]):not([href^="/#"]):not([href^="javascript:"])')[0])||null}var xf=/rect\s*\(([0-9]+)px,?\s*([0-9]+)px,?\s*([0-9]+)px,?\s*([0-9]+)px\s*\)/,Af=/(\w+)\((\d+)/,kf=function e(t,n,a){var o
...
return E&&(C=e(E,n,!0)),u&&(u[s]=C),C},Tf=function(e,t){for(var n=["fixed","sticky"],a=[],o=!1,i=0;i<e.length;++i){var u=e[i]
u===t&&(o=!0)
var s=r.getComputedStyle(u)
o||-1===n.indexOf(s.position)?a.push(u):a=[]}return a}
function Nf(e,t){var r=Bf(t)
do{var n=Bf(e)
if(n===r||n===t)return Rf(e,t)
e=n}while(e)
return!1}function Bf(e){for(var t=Za(e).parent;t;){if(Ch(t.actualNode))return t.actualNode
...
return Array.from(n.elementsFromPoint(t,r)||[]).filter(function(e){return Ei(e)===n}).reduce(function(n,a){if(yi(a)){var i=e(t,r,a.shadowRoot,o+1);(n=n.concat(i)).length&&Nf(n[0],a)&&n.push(a)}else n.push(a)
return n},[])}
function Sf(e){var t={}
...
o=a._isXHTML?o:(o||"").toLowerCase(),wm().includes(o)||(o="text"),a._type=o}return Xa.get("nodeMap")&&Xa.get("nodeMap").set(e,a),a}return B(t,e),W(t,[{key:"props",get:function(){if(!this._cache.hasOwnProperty("props")){var e=this.actualNode,t=e.nodeType,r=e.nodeName,n=e.id,a=e.nodeValue
...
return{node:e,include:[],exclude:[],initiator:!1,focusable:r&&dh(e),size:ph(e),page:n}}function dh(e){var t=Yh(e.getAttribute("tabindex"))
...
n.push.apply(n,q(u.map(function(e){return Za(e)})))}}return n.filter(function(e){return e})}function bh(e,t,r){e.frames=e.frames||[],ym(r.shift()).forEach(function(n){var a=e.frames.find(function(e){return e.node===n})
a||(a=ch(n,e),e.frames.push(a)),a[t].push(r)})}function yh(e,t){var n,i,u,s,l,c=this
...
throw new Error("No elements found for include in "+t+" Context")}}(this),Array.isArray(this.include)||(this.include=Array.from(this.include)),this.include.sort(Uh)}function Fh(e){return!1===(arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}).iframes?[]:new yh(e).frames.map(function(e){var t=e.node,r=j(e,F)
return r.initiator=!1,{frameSelector:Ga(t),frameContext:r}})}function wh(e){var t=i._audit.rules.find(function(t){return t.id===e})
if(!t)throw new Error("Cannot find rule by id: ".concat(e))
return t}function Eh(e,t){var r=e.getPropertyValue(t)
return["scroll","auto"].includes(r)}var Ch=Aa(function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,n=e.scrollWidth>e.clientWidth+t,a=e.scrollHeight>e.clientHeight+t
if(n||a){var o=r.getComputedStyle(e),i=Eh(o,"overflow-x"),u=Eh(o,"overflow-y")
return n&&i||a&&u?{elm:e,top:e.scrollTop,left:e.scrollLeft}:void 0}})
function xh(e){return Array.from(e.children||e.childNodes||[]).reduce(function(e,t){var r=Ch(t)
return r&&e.push(r),e.concat(xh(t))},[])}var Ah=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:r,t=e.document.documentElement
...
function kh(){return no(us)}var Th,Nh=function(e){if(!e)throw new Error("axe.utils.getStyleSheetFactory should be invoked with an argument")
...
return e.head.appendChild(c),{sheet:c.sheet,isCrossOrigin:a,shadowId:o,root:i,priority:u}}},Bh=function(e){if(Th&&Th.parentNode)return void 0===Th.styleSheet?Th.appendChild(a.createTextNode(e)):Th.styleSheet.cssText+=e,Th
...
function Rh(e){return!!e&&"object"===o(e)&&"number"==typeof e.length&&e instanceof r.Node==0}function _h(e,t){return!(!e||"object"!==o(e))&&Object.prototype.hasOwnProperty.call(e,t)}function Sh(e){return Oh(e)||Mh(e)}function Oh(e){return["include","exclude"].some(function(t){return _h(e,t)&&Mh(e[t])})}function Mh(e){return"string"==typeof e||e instanceof r.Node||Ih(e)||Ph(e)||Rh(e)}function Ih(e){return _h(e,"fromFrames")}function Ph(e){return _h(e,"fromShadowDom")}var jh=function e(t,n){var a=Za(t)
...
return a&&(a._isHidden=i),i},qh=function(e){var t,r,n=null!==(t=null===(r=e.props)||void 0===r?void 0:r.nodeName)&&void 0!==t?t:e.nodeName.toLowerCase()
return"http://www.w3.org/2000/svg"!==e.namespaceURI&&!!us.htmlElms[n]}
function Lh(e,t){var r=t.include,n=void 0===r?[]:r,a=t.exclude,o=void 0===a?[]:a,i=n.filter(function(t){return Di(t,e)})
if(0===i.length)return!1
var u=o.filter(function(t){return Di(t,e)})
if(0===u.length)return!0
var s=zh(i)
return Di(zh(u),s)}function zh(e){var t,r,n=Q(e)
try{for(n.s();!(r=n.n()).done;){var a=r.value
t&&Di(a,t)||(t=a)}}catch(e){n.e(e)}finally{n.f()}return t}function Vh(e,t){return e.length===t.length&&e.every(function(e,r){var n=t[r]
return Array.isArray(e)?e.length===n.length&&e.every(function(e,t){return n[t]===e}):e===n})}var Uh=function(e,t){return(e=e.actualNode||e)===(t=t.actualNode||t)?0:4&e.compareDocumentPosition(t)?-1:1}
function Hh(e){return e instanceof ra?{vNode:e,domNode:e.actualNode}:{vNode:Za(e),domNode:e}}var $h=function(e,t,r,n){var a=arguments.length>4&&void 0!==arguments[4]&&arguments[4],o=Array.from(e.cssRules)
...
return Wh(e,t,o,n,i)}),s=o.filter(function(e){return 3!==e.type})
return s.length?(u.push(Promise.resolve(t.convertDataToStylesheet({data:s.map(function(e){return e.cssText}).join(),isCrossOrigin:a,priority:r,root:t.rootNode,shadowId:t.shadowId}))),Promise.all(u)):Promise.all(u)},Gh=function(e,t,r,n){var a=arguments.length>4&&void 0!==arguments[4]&&arguments[4]
return function(e){try{return!(!e.cssRules&&e.href)}catch(e){return!1}}(e)?$h(e,t,r,n,a):Wh(e.href,t,r,n,!0)},Wh=function(e,t,n,a,o){return a.push(e),new Promise(function(t,n){var a=new r.XMLHttpRequest
...
return Gh(r.sheet,t,n,a,r.isCrossOrigin)})},Yh=function(e){if("string"!=typeof e)return null
var t=e.trim().match(/^([-+]?\d+)/)
return t?Number(t[1]):null},Qh=function(){function e(){if(r.performance&&r.performance)return r.performance.now()}var t=null,n=e()
...
function Kh(){if(a.elementsFromPoint)return a.elementsFromPoint
...
return a.head.removeChild(o),l}}"function"==typeof r.addEventListener&&(a.elementsFromPoint=Kh())
var Xh=function(e,t){return e.concat(t).filter(function(e,t,r){return r.indexOf(e)===t})}
function Zh(e,t,r,n,a){var o=a||{}
return o.vNodes=e,o.vNodesIndex=0,o.anyLevel=t,o.thisLevel=r,o.parentShadowId=n,o}var Jh=function(e,t,r){e=Array.isArray(e)?e:[e]
var n=go(t)
return Uf(e,n,r)||function(e,t,r){for(var n=Xa.get("qsa.recycledLocalVariables",function(){return[]}),a=[],o=Zh(Array.isArray(e)?e:[e],t,null,e[0].shadowId,n.pop()),i=[];o.vNodesIndex<o.vNodes.length;){for(var u,s,l=o.vNodes[o.vNodesIndex++],c=null,d=null,p=((null===(u=o.anyLevel)||void 0===u?void 0:u.length)||0)+((null===(s=o.thisLevel)||void 0===s?void 0:s.length)||0),f=!1,h=0;h<p;h++){var m,D,g,v=h<((null===(m=o.anyLevel)||void 0===m?void 0:m.length)||0)?o.anyLevel[h]:o.thisLevel[h-((null===(D=o.anyLevel)||void 0===D?void 0:D.length)||0)]
...
">"===b[0].combinator?(c=c||[]).push(b):(d=d||[]).push(b)}v[0].id&&l.shadowId!==o.parentShadowId||null===(g=o.anyLevel)||void 0===g||!g.includes(v)||(d=d||[]).push(v)}for(l.children&&l.children.length&&(a.push(o),o=Zh(l.children,d,c,l.shadowId,n.pop()));o.vNodesIndex===o.vNodes.length&&a.length;)n.push(o),o=a.pop()}return i}(e,n,r)},em=function(e){var t=e.treeRoot,r=function(e){var t=[],r=Jh(e,"*",function(e){return!t.includes(e.shadowId)&&(t.push(e.shadowId),!0)}).map(function(e){return{shadowId:e.shadowId,rootNode:wi(e.actualNode)}})
return Xh(r,[])}(void 0===t?i._tree[0]:t)
...
return n=11===e.nodeType&&t?function(e,t){return Array.from(e.children).filter(rm).reduce(function(r,n){var a=n.nodeName.toUpperCase(),o="STYLE"===a?n.textContent:n,i=t({data:o,isLink:"LINK"===a,root:e})
return i.sheet&&r.push(i.sheet),r},[])}(e,r):function(e){return Array.from(e.styleSheets).filter(function(e){return!!e.media&&nm(e.media.mediaText)})}(e),function(e){var t=[]
return e.filter(function(e){return!e.href||!t.includes(e.href)&&(t.push(e.href),!0)})}(n)}(a,o,t)
if(!i)return Promise.all(r)
var u=n+1,s={rootNode:a,shadowId:o,convertDataToStylesheet:t,rootIndex:u},l=[],c=Promise.all(i.map(function(e,t){return Gh(e,s,[u,t],l)}))
r.push(c)}),Promise.all(r)}(r,Nh(n)).then(function(e){return tm(e)})}
function tm(e){return e.reduce(function(e,t){return Array.isArray(t)?e.concat(tm(t)):e.concat(t)},[])}function rm(e){var t=e.nodeName.toUpperCase(),r=e.getAttribute("href"),n=e.getAttribute("rel"),a="LINK"===t&&r&&n&&e.rel.toUpperCase().includes("STYLESHEET")
return"STYLE"===t||a&&nm(e.media)}function nm(e){return!e||!e.toUpperCase().includes("PRINT")}var am=function(e){var t=e.treeRoot,r=void 0===t?i._tree[0]:t,n=Jh(r,"video[autoplay], audio[autoplay]",function(e){var t=e.actualNode
...
return im(e)?new Promise(function(r,n){var a=um(e),o=a.assets,i=a.timeout,u=setTimeout(function(){return n(new Error("Preload assets timed out."))},i)
...
clearTimeout(u),r(t)}).catch(function(e){clearTimeout(u),n(e)})}):Promise.resolve()}function im(e){return!e||void 0===e.preload||null===e.preload||("boolean"==typeof e.preload?e.preload:(t=e.preload,"object"===o(t)&&Array.isArray(t.assets)))
var t}function um(e){var t=Jn.preload,r=t.assets,n=t.timeout,a={assets:r,timeout:n}
...
return a.assets=Xh(e.preload.assets.map(function(e){return e.toLowerCase()}),[]),e.preload.timeout&&"number"==typeof e.preload.timeout&&!isNaN(e.preload.timeout)&&(a.timeout=e.preload.timeout),a}function sm(e){var t=i._audit.data.checks||{},r=i._audit.data.rules||{},n=pi(i._audit.rules,"id",e.id)||{}
e.tags=no(n.tags||[])
var a=lm(t,!0,n),o=lm(t,!1,n)
e.nodes.forEach(function(e){e.any.forEach(a),e.all.forEach(a),e.none.forEach(o)}),vi(e,no(r[e.id]||{}))}function lm(e,t,r){return function(n){var a=e[n.id]||{},i=a.messages||{},u=Object.assign({},a)
...
return n}catch(n){return"string"==typeof e.missingData?t.incomplete[e.missingData]:r(t)}}(n.data,i)),u.message||(u.message=i.incomplete)),"function"!=typeof u.message&&(u.message=oh(u.message,n.data)),vi(n,u)}}var cm=function(e,t){return Jh(e,t)}
function dm(e,t){var r,n,a=i._audit&&i._audit.tagExclude?i._audit.tagExclude:[]
return t.hasOwnProperty("include")||t.hasOwnProperty("exclude")?(r=t.include||[],r=Array.isArray(r)?r:[r],n=t.exclude||[],n=(n=Array.isArray(n)?n:[n]).concat(a.filter(function(e){return-1===r.indexOf(e)}))):(r=Array.isArray(t)?t:[t],n=a.filter(function(e){return-1===r.indexOf(e)})),!!(r.some(function(t){return-1!==e.tags.indexOf(t)})||0===r.length&&!1!==e.enabled)&&n.every(function(t){return-1===e.tags.indexOf(t)})}var pm=function(e,t,r){var n=r.runOnly||{},a=(r.rules||{})[e.id]
...
r=Xa.get(a,function(){return hm(r,n,e,t)})}else r=hm(r,n,e,t)
return Array.from(e.childNodes).forEach(function(e){r.appendChild(fm(e,t))}),r}function hm(e,t,r,n){return t?(e=a.createElement(e.nodeName),Array.from(t).forEach(function(t){(function(e,t,r){return void 0!==r[t]&&(!0===r[t]||Ca(e,r[t]))})(r,t.name,n)||e.setAttribute(t.name,t.value)}),e):e}function mm(e,t){var r,n=[]
if(i._selectCache)for(var a=0,o=i._selectCache.length;a<o;a++){var u=i._selectCache[a]
if(u.selector===e)return u.result}for(var s=t.include.reduce(function(e,t){return e.length&&Di(e[e.length-1],t)||e.push(t),e},[]),l=function(e){return e.exclude&&0!==e.exclude.length?function(t){return Lh(t,e)}:null}(t),c=0;c<s.length;c++)r=s[c],n=Dm(n,Jh(r,e,l))
return i._selectCache&&i._selectCache.push({selector:e,result:n}),n}function Dm(e,t){if(0===e.length)return t
if(e.length<t.length){var r=e
e=t,t=r}for(var n=0,a=t.length;n<a;n++)e.includes(t[n])||e.push(t[n])
return e}var gm=function(e){e.forEach(function(e){return function(e,t,n){if(e===r)return e.scroll(n,t)
e.scrollTop=t,e.scrollLeft=n}(e.elm,e.top,e.left)})}
function vm(e){return bm(Array.isArray(e)?q(e):[e],a)}function bm(e,t){var r=e.shift(),n=r?t.querySelector(r):null
return 0===e.length?n:null!=n&&n.shadowRoot?bm(e,n.shadowRoot):null}function ym(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:a,r=Array.isArray(e)?q(e):[e]
return 0===e.length?[]:Fm(r,t)}function Fm(e,t){var r,n=H(r=e)||L(r)||K(r)||U(),a=n[0],o=n.slice(1),i=t.querySelectorAll(a)
...
Array.isArray(e)?t=t.concat(Cm(e).map(function(e){return n+e})):t.push(n)}),t}var xm=function(e){for(var t=Em;e.length<3;)e+="`"
for(var r=0;r<=e.length-1;r++)if(!(t=t[e.charCodeAt(r)-96]))return!1
return!0},Am=function(e){function t(e){var r,n,a,i
return $(this,t),(r=k(this,t))._props=function(e){var t,r,n,a=null!==(t=e.nodeName)&&void 0!==t?t:Tm[e.nodeType],o=null!==(r=null!==(n=e.nodeType)&&void 0!==n?n:km[e.nodeName])&&void 0!==r?r:1
...
return null!==(t=this._attrs[e])&&void 0!==t?t:null}},{key:"hasAttr",value:function(e){return void 0!==this._attrs[e]}},{key:"attrNames",get:function(){return Object.keys(this._attrs)}}])}(ra),km={"#cdata-section":2,"#text":3,"#comment":8,"#document":9,"#document-fragment":11},Tm={}
Object.keys(km).forEach(function(e){Tm[km[e]]=e})
var Nm,Bm=Am,Rm=function(e,t){if(e=e||function(){},t=t||i.log,!i._audit)throw new Error("No audit configured")
...
i.utils.querySelectorAll(o,"iframe, frame").forEach(function(e){r.defer(function(t,r){return i.utils.sendCommandToFrame(e.actualNode,{command:"cleanup-plugin"},t,r)})}),r.then(function(r){0===n.length?e(r):t(n)}).catch(t)},_m={}
function Sm(e){return _m.hasOwnProperty(e)}function Om(e){return"string"==typeof e&&_m[e]?_m[e]:"function"==typeof e?e:Nm}var Mm={}
ce(Mm,{getAllCells:function(){return Im},getCellPosition:function(){return hs},getHeaders:function(){return jm},getScope:function(){return ms},isColumnHeader:function(){return Ds},isDataCell:function(){return qm},isDataTable:function(){return Lm},isHeader:function(){return zm},isRowHeader:function(){return gs},toArray:function(){return fs},toGrid:function(){return fs},traverse:function(){return Um}})
var Im=function(e){var t,r,n,a,o=[]
for(t=0,n=e.rows.length;t<n;t++)for(r=0,a=e.rows[t].cells.length;r<a;r++)o.push(e.rows[t].cells[r])
return o}
function Pm(e,t,r){for(var n,a="row"===e?"_rowHeaders":"_colHeaders",o="row"===e?gs:Ds,u=r[t.y][t.x],s=u.colSpan-1,l=u.getAttribute("rowspan"),c=(0===parseInt(l)||0===u.rowspan?r.length:u.rowSpan)-1,d=t.y+c,p=t.x+s,f="row"===e?t.y:0,h="row"===e?0:t.x,m=[],D=d;D>=f&&!n;D--)for(var g=p;g>=h;g--){var v=r[D]?r[D][g]:void 0
if(v){var b=i.utils.getNodeFromTree(v)
if(b[a]){n=b[a]
break}m.push(v)}}return n=(n||[]).concat(m.filter(o)),m.forEach(function(e){i.utils.getNodeFromTree(e)[a]=n}),n}var jm=function(e,t){if(e.getAttribute("headers")){var r=Ju(e,"headers")
if(r.filter(function(e){return e}).length)return r}t||(t=fs(Ai(e,"table")))
var n=hs(e,t),a=Pm("row",n,t),o=Pm("col",n,t)
...
h=r.getComputedStyle(o).getPropertyValue("background-image")}return s>=20||!(Qi(e).width>.95*Ki(r).width)&&!(u<10)&&!e.querySelector("object, embed, iframe, applet")},zm=function(e){if(Ds(e)||gs(e))return!0
if(e.getAttribute("id")){var t=va(e.getAttribute("id"))
return!!a.querySelector('[headers~="'.concat(t,'"]'))}return!1}
function Vm(e,t,r,n){var a,o=r[t.y]?r[t.y][t.x]:void 0
return o?"function"==typeof n&&!0===(a=n(o,t,r))?[o]:((a=Vm(e,{x:t.x+e.x,y:t.y+e.y},r,n)).unshift(o),a):[]}var Um=function(e,t,r,n){if(Array.isArray(t)&&(n=r,r=t,t={x:0,y:0}),"string"==typeof e)switch(e){case"left":e={x:-1,y:0}
break
case"up":e={x:0,y:-1}
break
case"right":e={x:1,y:0}
break
case"down":e={x:0,y:1}}return Vm(e,{x:t.x+e.x,y:t.y+e.y},r,n)},Hm={}
ce(Hm,{allowedAttr:function(){return $m},arialabelText:function(){return rs},arialabelledbyText:function(){return ts},getAccessibleRefs:function(){return Ym},getElementUnallowedRoles:function(){return Zm},getExplicitRole:function(){return cs},getImplicitRole:function(){return js},getOwnedVirtual:function(){return Ws},getRole:function(){return Us},getRoleType:function(){return Yl},getRolesByType:function(){return eD},getRolesWithNameFromContents:function(){return rD},implicitNodes:function(){return uD},implicitRole:function(){return js},isAccessibleRef:function(){return sD},isAriaRoleAllowedOnElement:function(){return Qm},isComboboxPopup:function(){return lD},isUnsupportedRole:function(){return ss},isValidRole:function(){return ls},label:function(){return dD},labelVirtual:function(){return kl},lookupTable:function(){return iD},namedFromContents:function(){return Gs},requiredAttr:function(){return pD},requiredContext:function(){return fD},requiredOwned:function(){return hD},validateAttr:function(){return DD},validateAttrValue:function(){return mD}})
var $m=function(e){var t=us.ariaRoles[e],r=q(ps())
return t?(t.allowedAttrs&&r.push.apply(r,q(t.allowedAttrs)),t.requiredAttrs&&r.push.apply(r,q(t.requiredAttrs)),r):r},Gm=/^idrefs?$/
function Wm(e,t,r){if(e.hasAttribute){if("LABEL"===e.nodeName.toUpperCase()&&e.hasAttribute("for")){var n=e.getAttribute("for")
...
return!(!t.parentNode||"http://www.w3.org/2000/svg"!==t.parentNode.namespaceURI)||r}},oD.rolesOfType={widget:["button","checkbox","dialog","gridcell","link","log","marquee","menuitem","menuitemcheckbox","menuitemradio","option","progressbar","radio","scrollbar","searchbox","slider","spinbutton","status","switch","tab","tabpanel","textbox","timer","tooltip","tree","treeitem"]}
var iD=oD,uD=function(e){var t=null,r=iD.role[e]
return r&&r.implicit&&(t=no(r.implicit)),t},sD=function(e){return!!Ym(e).length}
function lD(e){var t,r=(arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}).popupRoles,n=Us(e)
...
return Array.from(i).some(cD)}var cD=function(e){return e&&"combobox"===Us(e)},dD=function(e){return e=Za(e),kl(e)},pD=function(e){var t=us.ariaRoles[e]
...
return t&&Array.isArray(t.requiredOwned)?q(t.requiredOwned):null},mD=function(e,t){var r,n,a=(e=e instanceof ra?e:Za(e)).attr(t),o=us.ariaAttrs[t]
if(!o)return!0
...
function yD(e,t){var r=e.actualNode
if("button"===Us(e)||function(e,t){var r=e.actualNode,n=Us(e),a=(r.getAttribute("aria-live")||"").toLowerCase().trim(),o=Jm("landmark")
return!!(["assertive","polite"].includes(a)||bD.includes(n)||o.includes(n)||t.regionMatcher&&Is(e,t.regionMatcher))}(e,t)||["iframe","frame"].includes(e.props.nodeName)||Ef(e.actualNode)&&Lu(e.actualNode,"href")||!Qs(r)){for(var n=e;n;)n._hasRegionDescendant=!0,n=n.parent
...
case"bolder":return 900}return e=parseInt(e),isNaN(e)?400:e}function wD(e){var t=r.getComputedStyle(function(e){for(var t=e,r=e.textContent.trim(),n=r;n===r&&void 0!==t;){var a=-1
...
return{fontWeight:FD(t.getPropertyValue("font-weight")),fontSize:parseInt(t.getPropertyValue("font-size")),isItalic:"italic"===t.getPropertyValue("font-style")}}function ED(e,t,r){return r.reduce(function(r,n){return r||(!n.size||e.fontSize/n.size>t.fontSize)&&(!n.weight||e.fontWeight-n.weight>t.fontWeight)&&(!n.italic||e.isItalic&&!t.isItalic)},!1)}var CD=/[;,\s]/,xD=/^[0-9.]+$/,AD={}
ce(AD,{aria:function(){return Hm},color:function(){return kD},dom:function(){return Fi},forms:function(){return ug},matches:function(){return Is},math:function(){return nu},standards:function(){return vD},table:function(){return Mm},text:function(){return Zu},utils:function(){return na}})
var kD={}
ce(kD,{Color:function(){return bf},centerPointOfRect:function(){return TD},elementHasImage:function(){return oc},elementIsDistinct:function(){return BD},filteredRectStack:function(){return _D},flattenColors:function(){return MD},flattenShadowColors:function(){return PD},getBackgroundColor:function(){return eg},getBackgroundStack:function(){return jD},getContrast:function(){return ng},getForegroundColor:function(){return ag},getOwnBackgroundColor:function(){return Ff},getRectStack:function(){return RD},getStackingContext:function(){return QD},getStrokeColorsFromShadows:function(){return HD},getTextShadowColors:function(){return WD},hasValidContrastRatio:function(){return ig},incompleteData:function(){return ac},parseTextShadows:function(){return GD},stackingContextToColor:function(){return KD}})
var TD=function(e){if(!(e.left>r.innerWidth||e.top>r.innerHeight))return{x:Math.min(Math.ceil(e.left+e.width/2),r.innerWidth-1),y:Math.min(Math.ceil(e.top+e.height/2),r.innerHeight-1)}}
function ND(e){return e.getPropertyValue("font-family").split(/[,;]/g).map(function(e){return e.trim().toLowerCase()})}var BD=function(e,t){var n=r.getComputedStyle(e)
...
return i.split(" ").length<3&&(o=o||i!==a.getPropertyValue("text-decoration")),o},RD=function(e){var t=$u(e),r=Ml(e)
return!r||r.length<=1?[t]:r.some(function(e){return void 0===e})?null:(r.splice(0,0,t),r)},_D=function(e){var t=RD(e)
if(t&&1===t.length)return t[0]
if(t&&t.length>1){var r,n=t.shift()
return t.forEach(function(a,o){if(0!==o){var i=t[o-1],u=t[o]
r=i.every(function(e,t){return e===u[t]})||n.includes(e)}}),r?t[0]:(ac.set("bgColor","elmPartiallyObscuring"),null)}return ac.set("bgColor","outsideViewport"),null},SD=["hue","saturation","color","luminosity"],OD={normal:function(e,t){return t},multiply:function(e,t){return t*e},screen:function(e,t){return e+t-e*t},overlay:function(e,t){return this["hard-light"](t,e)},darken:function(e,t){return Math.min(e,t)},lighten:function(e,t){return Math.max(e,t)},"color-dodge":function(e,t){return 0===e?0:1===t?1:Math.min(1,e/(1-t))},"color-burn":function(e,t){return 1===e?1:0===t?0:1-Math.min(1,(1-e)/t)},"hard-light":function(e,t){return t<=.5?this.multiply(e,2*t):this.screen(e,2*t-1)},"soft-light":function(e,t){return t<=.5?e-(1-2*t)*e*(1-e):e+(2*t-1)*((e<=.25?((16*e-12)*e+4)*e:Math.sqrt(e))-e)},difference:function(e,t){return Math.abs(e-t)},exclusion:function(e,t){return e+t-2*e*t},hue:function(e,t){return t.setSaturation(e.getSaturation()).setLuminosity(e.getLuminosity())},saturation:function(e,t){return e.setSaturation(t.getSaturation()).setLuminosity(e.getLuminosity())},color:function(e,t){return t.setLuminosity(e.getLuminosity())},luminosity:function(e,t){return e.setLuminosity(t.getLuminosity())}}
function MD(e,t){var r,n=function(e,t,r){if(SD.includes(r))return OD[r](e,t)
var n=new bf
return["r","g","b"].forEach(function(a){n[a]=OD[r](e[a],t[a])}),n}(t,e,arguments.length>2&&void 0!==arguments[2]?arguments[2]:"normal"),a=ID(e.red,e.alpha,t.red,t.alpha,255*n.r),o=ID(e.green,e.alpha,t.green,t.alpha,255*n.g),i=ID(e.blue,e.alpha,t.blue,t.alpha,255*n.b),u=(r=e.alpha+t.alpha*(1-e.alpha),Math.min(Math.max(0,r),1))
if(0===u)return new bf(a,o,i,u)
var s=Math.round(a/u),l=Math.round(o/u),c=Math.round(i/u)
return new bf(s,l,c,u)}function ID(e,t,r,n,a){return t*(1-n)*e+t*n*a+(1-t)*n*r}function PD(e,t){var r=e.alpha,n=(1-r)*t.red+r*e.red,a=(1-r)*t.green+r*e.green,o=(1-r)*t.blue+r*e.blue,i=e.alpha+t.alpha*(1-e.alpha)
return new bf(n,a,o,i)}function jD(e){for(var t=Ml(e).map(function(t){return function(e){var t=e.indexOf(a.body),n=e,o=Ff(r.getComputedStyle(a.documentElement))
if(t>1&&0===o.alpha&&!oc(a.documentElement)){t>1&&(n.splice(t,1),n.push(a.body))
var i=n.indexOf(a.documentElement)
i>0&&(n.splice(i,1),n.push(a.documentElement))}return n}(t=Tf(t,e))}),n=0;n<t.length;n++){var o=t[n]
if(o[0]!==e)return ac.set("bgColor","bgOverlap"),null
if(0!==n&&!qD(o,t[0]))return ac.set("bgColor","elmPartiallyObscuring"),null}return t[0]||null}function qD(e,t){if(e===t)return!0
if(null===e||null===t)return!1
if(e.length!==t.length)return!1
for(var r=0;r<e.length;++r)if(e[r]!==t[r])return!1
return!0}var LD=.54,zD=.5,VD=1.5,UD=["top","right","bottom","left"]
function HD(e){var t=(arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}).ignoreEdgeCount,r=void 0!==t&&t,n=function(e){var t,r={},n=Q(e)
...
c>zD?s.right.push(c):-c>zD&&s.left.push(-c),d>zD?s.bottom.push(d):-d>zD&&s.top.push(-d)}}catch(e){n.e(e)}finally{n.f()}return r}(e),a=Object.entries(n).map(function(e){var t=V(e,2),r=t[0],n=t[1],a=UD.filter(function(e){return 0!==n[e].length}).length
return{colorStr:r,sides:n,edgeCount:a}})
return!r&&a.some(function(e){var t=e.edgeCount
return t>1&&t<4})?null:a.map($D).filter(function(e){return null!==e})}function $D(e){var t=e.colorStr,r=e.sides
if(4!==e.edgeCount)return null
var n=new bf
n.parseString(t)
var a=0,o=!0
return UD.forEach(function(e){a+=r[e].length/4,o&&(o=r[e].every(function(e){return e>VD}))}),o||(n.alpha=1-Math.pow(LD,a)),n}function GD(e){var t={pixels:[]},r=e.trim(),n=[t]
if(!r)return[]
...
2===t.length&&t.push(0)}),n}function WD(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=t.minRatio,a=t.maxRatio,o=t.ignoreEdgeCount,i=[],u=r.getComputedStyle(e),s=u.getPropertyValue("text-shadow")
if("none"===s)return i
...
else{if(p.length>0){var F=HD(p,{ignoreEdgeCount:o})
if(null===F)return null
i.push.apply(i,q(F)),p.splice(0,p.length)}var w=YD({colorStr:m,offsetX:g,offsetY:v,blurRadius:y,fontSize:c})
i.push(w)}}}catch(e){f.e(e)}finally{f.f()}if(p.length>0){var E=HD(p,{ignoreEdgeCount:o})
if(null===E)return null
i.push.apply(i,q(E))}return i}function YD(e){var t=e.colorStr,r=e.offsetX,n=e.offsetY,a=e.blurRadius,o=e.fontSize
if(r>a||n>a)return new bf(0,0,0,0)
var i=new bf
return i.parseString(t),i.alpha*=function(e,t){return 0===e?1:.185/(e/t+.4)}(a,o),i}function QD(e,t){var r,n=Za(e)
if(n._stackingContext)return n._stackingContext
var a=[],o=new Map
return(t=null!==(r=t)&&void 0!==r?r:jD(e)).forEach(function(e){var t,r=Za(e),n=function(e){var t=new bf
...
i.forEach(function(e,t){var r,n=e.vNode,u=null===(r=i[t-1])||void 0===r?void 0:r.vNode,s=JD(o,n,u)
0!==t||o.get(n)||a.unshift(s),o.set(n,s)})
var u=null===(t=i[i.length-1])||void 0===t?void 0:t.vNode,s=JD(o,r,u)
i.length||a.unshift(s),s.bgColor=n}),n._stackingContext=a,a}function KD(e){var t
if(null===(t=e.descendants)||void 0===t||!t.length){var r=e.bgColor
return r.alpha*=e.opacity,{color:r,blendMode:e.blendMode}}var n=MD(e.descendants.reduce(XD,ZD()),e.bgColor,e.descendants[0].blendMode)
return n.alpha*=e.opacity,{color:n,blendMode:e.blendMode}}function XD(e,t){var r
return r=e instanceof bf?e:KD(e).color,MD(KD(t).color,r,t.blendMode)}function ZD(e,t){var r,n
return{vNode:e,ancestor:t,opacity:parseFloat(null!==(r=null==e?void 0:e.getComputedStylePropertyValue("opacity"))&&void 0!==r?r:1),bgColor:new bf(0,0,0,0),blendMode:(n=null==e?void 0:e.getComputedStylePropertyValue("mix-blend-mode"),n||void 0),descendants:[]}}function JD(e,t,r){var n,a=e.get(r),o=null!==(n=e.get(t))&&void 0!==n?n:ZD(t,a)
return a&&r!==t&&!a.descendants.includes(o)&&a.descendants.unshift(o),o}function eg(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[],n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:.1,o=Za(e),i=o._cache.getBackgroundColor
if(i)return t.push.apply(t,q(i.bgElms)),ac.set("bgColor",i.incompleteData),i.bgColor
var u=function(e,t,n){var o,i,u=jD(e)
if(!u)return null
var s=Sl(e),l=null!==(o=WD(e,{minRatio:n,ignoreEdgeCount:!0}))&&void 0!==o?o:[]
...
if(t.push(d),1===f.alpha)break}}l=QD(e,u).map(KD).concat(l)
var h=function(e,t){var n=[]
if(!t){var o=a.documentElement,i=a.body,u=r.getComputedStyle(o),s=r.getComputedStyle(i),l=Ff(u),c=Ff(s),d=0!==c.alpha&&tg(i,e.getBoundingClientRect());(0!==c.alpha&&0===l.alpha||d&&1!==c.alpha)&&n.unshift({color:c,blendMode:rg(s.getPropertyValue("mix-blend-mode"))}),0!==l.alpha&&(!d||d&&1!==c.alpha)&&n.unshift({color:l,blendMode:rg(u.getPropertyValue("mix-blend-mode"))})}return n}(e,u.includes(a.body))
...
return MD(m.color instanceof bf?m.color:m,new bf(255,255,255,1))}(e,t,n)
...
return(["scroll","auto"].includes(i)||e instanceof r.HTMLHtmlElement)&&(a=n.left+e.scrollWidth,o=n.top+e.scrollHeight),t.every(function(e){return e.top>=n.top&&e.bottom<=o&&e.left>=n.left&&e.right<=a})}function rg(e){return e||void 0}var ng=function(e,t){if(!t||!e)return null
t.alpha<1&&(t=MD(t,e))
var r=e.getRelativeLuminance(),n=t.getRelativeLuminance()
return(Math.max(n,r)+.05)/(Math.min(n,r)+.05)}
function ag(e,t,n){for(var a,o=arguments.length>3&&void 0!==arguments[3]?arguments[3]:{},i=r.getComputedStyle(e),u=[function(){return function(e,t){var r=t.textStrokeEmMin,n=void 0===r?0:r,a=parseFloat(e.getPropertyValue("-webkit-text-stroke-width"))
if(0===a)return null
...
return(new bf).parseString(u)}(i,o)},function(){return function(e){return(new bf).parseString(e.getPropertyValue("-webkit-text-fill-color")||e.getPropertyValue("color"))}(i)},function(){return WD(e,{minRatio:0})}],s=[],l=0,c=u;l<c.length;l++){var d=(0,c[l])()
if(d&&(s=s.concat(d),1===d.alpha))break}var p=s.reduce(function(e,t){return MD(e,t)})
if(null!==(a=n)&&void 0!==a||(n=eg(e,[])),null===n){var f=ac.get("bgColor")
return ac.set("fgColor",f),null}var h=QD(e)
return MD(function(e,t,r){for(;t;){var n
...
e=MD(e,i),t=t.ancestor}else t=t.ancestor}}return e}(p,og(h,e),h),new bf(255,255,255,1))}function og(e,t){var r,n=Q(e)
try{for(n.s();!(r=n.n()).done;){var a,o=r.value
if((null===(a=o.vNode)||void 0===a?void 0:a.actualNode)===t)return o
var i=og(o.descendants,t)
if(i)return i}}catch(e){n.e(e)}finally{n.f()}}var ig=function(e,t,r,n){var a=ng(e,t),o=n&&Math.ceil(72*r)/96<14||!n&&Math.ceil(72*r)/96<18?4.5:3
return{isValid:a>o,contrastRatio:a,expectedContrastRatio:o}},ug={}
ce(ug,{isAriaCombobox:function(){return nl},isAriaListbox:function(){return rl},isAriaRange:function(){return ol},isAriaTextbox:function(){return tl},isDisabled:function(){return lg},isNativeSelect:function(){return el},isNativeTextbox:function(){return Js}})
var sg=["fieldset","button","select","input","textarea"],lg=function e(t){var r=t._isDisabled
if("boolean"==typeof r)return r
var n=t.props.nodeName,a=t.attr("aria-disabled")
return r=!(!sg.includes(n)||!t.hasAttr("disabled"))||(a?"true"===a.toLowerCase():!!t.parent&&e(t.parent)),t._isDisabled=r,r}
...
return o(n)===o(a)&&("object"===o(n)||"object"===o(a)?cg(n,a):n===a)})}function dg(e){var t=Us(e),r=t&&t.includes("heading"),n=e.attr("aria-level"),a=parseInt(n,10),o=V(e.props.nodeName.match(/h(\d)/)||[],2)[1]
return r?o&&!n?parseInt(o,10):isNaN(a)||a<1?o?parseInt(o,10):2:a||-1:-1}function pg(e,t){var r,n=null===(r=t.data)||void 0===r?void 0:r.headingOrder,a=hg(t.node.ancestry,1)
if(!n)return e
var o=n.map(function(e){return function(e,t){return z({},e,{ancestry:t.concat(e.ancestry)})}(e,a)}),i=function(e,t){for(;t.length;){var r=fg(e,t)
if(-1!==r)return r
t=hg(t,1)}return-1}(e,a)
return-1===i?e.push.apply(e,q(o)):e.splice.apply(e,[i,0].concat(q(o))),e}function fg(e,t){return e.findIndex(function(e){return Vh(e.ancestry,t)})}function hg(e,t){return e.slice(0,e.length-t)}function mg(e,t){var r=e.boundingClientRect,n=t.boundingClientRect
return r.top>=n.top&&r.left>=n.left&&r.bottom<=n.bottom&&r.right<=n.right}function Dg(e){return e.getComputedStylePropertyValue("pointer-events")}function gg(e){return{width:Math.round(10*e.width)/10,height:Math.round(10*e.height)/10}}function vg(e,t){return Di(e,t)&&!Qu(t)}function bg(e){return e.map(function(e){return e.actualNode})}function yg(e){return Math.round(10*e)/10}function Fg(e,t,r){var n=r.validRoles,a=void 0===n?[]:n,o=r.validNodeNames,i=void 0===o?[]:o,u=e.props,s=u.nodeName,l=u.nodeType,c=u.nodeValue,d=t?"div > ":""
...
return[]}var t=[]
return e.children.forEach(function(e){"widget"===Yl(e)&&Yu(e)?t.push(e):t.push.apply(t,q(Ag(e)))}),t}function kg(e){var t=Yh(e.attr("tabindex"))
...
return-1!==Ng.indexOf(t)||"table-"===t.substr(0,6)}function Rg(e,t){var r=e.getRelativeLuminance(),n=t.getRelativeLuminance()
return(Math.max(r,n)+.05)/(Math.min(r,n)+.05)}var _g=["block","list-item","table","flex","grid","inline-block"]
function Sg(e){var t=r.getComputedStyle(e).getPropertyValue("display")
return-1!==_g.indexOf(t)||"table-"===t.substr(0,6)}var Og=Aa(function(e,t){var n=r.getComputedStyle(e,t),a=function(e,t){return n.getPropertyValue(e)===t}
...
var o=Mg(n.getPropertyValue("width")),i=Mg(n.getPropertyValue("height"))
return"px"!==o.unit||"px"!==i.unit?0===o.value||0===i.value?0:1/0:o.value*i.value})
function Mg(e){var t=V(e.match(/^([0-9.]+)([a-z]+)$/i)||[],3),r=t[1],n=void 0===r?"":r,a=t[2],o=void 0===a?"":a
return{value:parseFloat(n),unit:o.toLowerCase()}}var Ig={ARTICLE:!0,ASIDE:!0,NAV:!0,SECTION:!0},Pg={alert:!0,alertdialog:!0,application:!0,article:!0,banner:!1,complementary:!0,contentinfo:!0,dialog:!0,form:!0,log:!0,main:!0,navigation:!0,region:!0,search:!1,status:!0,tabpanel:!0}
function jg(e,t,r,n){var a=cs(e)
if(r||(r=fD(a)),!r)return null
for(var o=r.includes("group"),i=n?e:e.parent;i;){var u=Us(i,{noPresentational:!0})
if(u){if("group"!==u||!o)return r.includes(u)?null:r
t.includes(a)&&r.push(a),r=r.filter(function(e){return"group"!==e}),i=i.parent}else i=i.parent}return r}function qg(e){var t=e.vNode
return 3===t.props.nodeType?t.props.nodeValue.trim().length>0:Ll(t,!1,!0)}var Lg=Aa(function(e){if(e){var t=Us(e,{noPresentational:!0,chromium:!0})
return t?Yl(t):Lg(e.parent)}})
function zg(e){var t,r,n=(arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}).invalidTableRowAttrs,a=arguments.length>2?arguments[2]:void 0,o=null!==(t=null==n||null===(r=n.filter)||void 0===r?void 0:r.call(n,function(e){return a.hasAttr(e)}))&&void 0!==t?t:[]
...
return this.data({messageKey:s,invalidAttrs:o,ownerRole:u}),!1}function Vg(e,t,r){var n,a=r.props,o=a.nodeName,i=a.type,u=(n=r.attr("aria-checked"))?(n=n.toLowerCase(),["mixed","true"].includes(n)?n:"false"):""
if("input"!==o||"checkbox"!==i||!u)return!0
var s,l=(s=r).props.indeterminate?"mixed":s.props.checked?"true":"false"
return u===l||(this.data({messageKey:"checkbox",checkState:l}),!1)}var Ug={row:zg,checkbox:Vg}
function Hg(e,t,r){return"aria-required"===e&&"false"===t||!("aria-multiline"!==e||"false"!==t||!r.hasAttr("contenteditable"))}var $g=function(e,t){try{return"svg"===t.props.nodeName||!!yo(t,"svg")}catch(e){return!1}},Gg=[function(e,t){return Wg(t)},function(e,t){return function(e){return"area"!==e.props.nodeName}(t)},function(e,t){return!$g(0,t)},function(e,t){return Yu(t)},function(e,t){return Qu(t)||!Yg(t)},function(e){return!Zl(e,{noLengthCompare:!0})}]
function Wg(e){return"widget"===Yl(e)}var Yg=Aa(function e(t){return!(null==t||!t.parent)&&(!(!Wg(t.parent)||!Qu(t.parent))||e(t.parent))}),Qg=function(e,t){var r=cs(t)
...
return r.setStart(e,0),r.setEnd(e,e.childNodes.length),0===r.getClientRects().length}var Xg=function(e,t,r){return r.initiator},Zg={emoji:!0,nonBmp:!1,punctuations:!0}
function Jg(e){return!e||"true"!==e.getAttribute("aria-hidden")&&Jg(Wi(e))}var ev={"abstractrole-evaluate":function(e,t,r){var n=zf(r.attr("role")).filter(function(e){return"abstract"===Yl(e)})
...
return"string"==typeof n&&/^\s+$/.test(n)},"aria-allowed-attr-evaluate":function(e,t,r){var n=[],a=Us(r),o=$m(a)
Array.isArray(t[a])&&(o=Xh(t[a].concat(o)))
var i,u=Q(r.attrNames)
try{for(u.s();!(i=u.n()).done;){var s=i.value
!DD(s)||o.includes(s)||Hg(s,r.attr(s),r)||n.push(s)}}catch(e){u.e(e)}finally{u.f()}return!n.length||(this.data(n.map(function(e){return e+'="'+r.attr(e)+'"'})),!(a||qh(r)||Yu(r))&&void 0)},"aria-allowed-attr-matches":function(e,t){var r=/^aria-/,n=t.attrNames
...
return!Ug[n]||Ug[n].call(this,e,t,r)},"aria-conditional-checkbox-attr-evaluate":Vg,"aria-conditional-row-attr-evaluate":zg,"aria-errormessage-evaluate":function(e,t,r){t=Array.isArray(t)?t:[]
...
return a?a.prohibitedAttrs||[]:t||n.includes(r)||"widget"===Lg(e)?[]:["aria-label","aria-labelledby"]}(r,o,a,n).filter(function(e){return!!r.attrNames.includes(e)&&""!==vs(r.attr(e))})
if(0===i.length)return!1
...
return""===vs(s)||void 0},"aria-required-attr-evaluate":function(e){var t,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=arguments.length>2?arguments[2]:void 0,a=cs(n),o=n.attrNames,i=pD(a)
if(Array.isArray(r[a])&&(i=Xh(r[a],i)),!a||!o.length||!i.length)return!0
...
return!s.length||(this.data(s),!1)},"aria-required-children-evaluate":function(e,t,r){var n=t&&Array.isArray(t.reviewEmpty)?t.reviewEmpty:[],a=cs(r,{dpub:!0}),o=hD(a)
if(null===o)return!0
...
return r&&e.includes(r)})}(o,i)||("true"===r.attr("aria-busy")?(this.data({messageKey:"aria-busy"}),!0):(this.data(o),!(!n.includes(a)||i.some(qg))&&void 0))},"aria-required-children-matches":function(e,t){var r=cs(t,{dpub:!0})
return!!hD(r)},"aria-required-parent-evaluate":function(e,t,r){var n=t&&Array.isArray(t.ownGroupRoles)?t.ownGroupRoles:[],a=jg(r,n)
if(!a)return!0
...
if(o)for(var i=0,u=o.length;i<u;i++)if(!(a=jg(Za(o[i]),n,a,!0)))return!0
return this.data(a),!1},"aria-required-parent-matches":function(e,t){var r=cs(t)
return!!fD(r)},"aria-roledescription-evaluate":function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=Us(arguments.length>2?arguments[2]:void 0)
...
var n=[],a=/^aria-/
return r.attrNames.forEach(function(e){-1===t.indexOf(e)&&a.test(e)&&!DD(e)&&n.push(e)}),!n.length||(this.data(n),!1)},"aria-valid-attr-value-evaluate":function(e,t,r){t=Array.isArray(t.value)?t.value:[]
...
try{i=mD(r,e)}catch(t){return n="".concat(e,'="').concat(c,'"'),void(a="idrefs")}l[e]&&!l[e](i)||i||(""!==c||function(e){var t
...
return c=wm().includes(c)?c:"text",void 0===l?"text"===c:l.includes(c)},"autocomplete-matches":function(e,t){var r=t.attr("autocomplete")
if(!r||""===vs(r))return!1
...
var o=t.attr("role"),i=Yh(t.attr("tabindex"))
...
return"string"!=typeof o?(this.data({messageKey:"noRoleDescription"}),!1):""!==vs(o)||(this.data({messageKey:"emptyRoleDescription"}),!1)},"bypass-matches":function(e,t,r){return!Xg(0,0,r)||!!e.querySelector("a[href]")},"caption-evaluate":function(e,t,r){return!cm(r,"track").some(function(e){return"captions"===(e.attr("kind")||"").toLowerCase()})&&void 0},"caption-faked-evaluate":function(e){var t=fs(e),r=t[0]
...
do{if(Og(e.actualNode,":before")+Og(e.actualNode,":after")>i)return e}while(e=e.parent)}}(n,{ignorePseudo:i,pseudoSizeThreshold:p})
...
var C=WD(e,{minRatio:.001,maxRatio:d})
if(null!==C){var x=[],A=eg(e,x,d),k=ag(e,!1,A,t),T=null,N=null,B=null
if(0===C.length)T=ng(A,k)
else if(k&&A){B=[].concat(q(C),[A]).reduce(PD)
var R=ng(A,k),_=ng(A,B),S=ng(B,k);(T=Math.max(R,_,S))!==R&&(N=_>S?"shadowOnBgColor":"fgOnShadowColor")}var O=T>y
...
if(m&&lg(m))return!1}for(var D=[],g=t;g;){if(g.props.id){var v=Ym(g).filter(function(e){return zf(e.getAttribute("aria-labelledby")||"").includes(g.props.id)}).map(function(e){return Za(e)})
...
return t.length>=3&&t[0].length>=3&&t[1].length>=3&&t[2].length>=3}return!1},"data-table-matches":function(e){return Lm(e)},"deprecatedrole-evaluate":function(e,t,r){var n=Us(r,{dpub:!0,fallback:!0}),a=us.ariaRoles[n]
...
return!sD(e)&&n.some(Yu)},"duplicate-id-after":function(e){var t=[]
...
return!sD(e)&&n.every(function(e){return!Yu(e)})},"duplicate-img-label-evaluate":function(e,t,r){if(["none","presentation"].includes(Us(r)))return!1
...
var o=a.filter(function(e){return!n.includes(e.props.nodeName)})
return this.relatedNodes(o.map(function(e){return e.actualNode})),!(0!==o.length&&!Jl())||!!o.every(function(e){var t=e.getComputedStylePropertyValue("pointer-events"),r=parseInt(e.getComputedStylePropertyValue("width")),n=parseInt(e.getComputedStylePropertyValue("height"))
return e.actualNode.onfocus||(0===r||0===n)&&"none"===t})&&void 0},"frame-focusable-content-evaluate":function(e,t,r){if(r.children)try{return!r.children.some(function(e){return Tg(e)})}catch(e){return}},"frame-focusable-content-matches":function(e,t,r){var n,a
...
var n=Jh(r,t.selector,function(e){return Qs(e)})
...
return t.attributes.includes("xml:lang")&&t.attributes.includes("lang")&&Cg(r.attr("xml:lang"))&&!Cg(r.attr("lang"))&&!n?(this.data({messageKey:"noXHTML"}),!1):!!t.attributes.some(function(e){return Cg(r.attr(e))})||(this.data({messageKey:"noLang"}),!1)},"has-text-content-evaluate":function(e,t,r){try{return""!==vs(dl(r))}catch(e){return}},"has-widget-role-evaluate":function(e){var t=e.getAttribute("role")
if(null===t)return!1
var r=Yl(t)
...
return r.ancestry.length-n.ancestry.length}),e.reduce(pg,[]).filter(function(e){return-1!==e.level})}(e)
return e.forEach(function(e){e.result=function(e,t){var r,n,a,o,i=fg(t,e.node.ancestry),u=null!==(r=null===(n=t[i])||void 0===n?void 0:n.level)&&void 0!==r?r:-1,s=null!==(a=null===(o=t[i-1])||void 0===o?void 0:o.level)&&void 0!==a?a:-1
...
return e=t.map(function(e){return{ancestry:[Ga(e.actualNode)],level:dg(e)}}),this.data({headingOrder:e}),Xa.set("headingOrder",t),!0},"help-same-as-label-evaluate":function(e,t,r){var n=Nl(r),a=e.getAttribute("title")
...
if(o&&!Qs(o)){var i
try{i=Fl(r).trim()}catch(e){return}return""===i}}return!1},"html-namespace-matches":function(e,t){return!$g(0,t)},"html5-scope-evaluate":function(e){return!Wl(a)||"TH"===e.nodeName.toUpperCase()},"identical-links-same-purpose-after":function(e){if(e.length<2)return e
for(var t=e.filter(function(e){return void 0!==e.result}),r=[],n={},a=function(e){var a,o=t[e],i=o.data,u=i.name,s=i.urlProps
if(n[u])return 1
var l=t.filter(function(t,r){return t.data.name===u&&r!==e}),c=l.every(function(e){return cg(e.data.urlProps,s)})
...
return this.data(z({value:f},d)),"number"==typeof f?("number"!=typeof o||f>=o)&&("number"!=typeof i||f<=i):void 0},"inserted-into-focus-order-matches":function(e){return Ul(e)},"internal-link-present-evaluate":function(e,t,r){return cm(r,"a[href]").some(function(e){return/^#[^/!]/.test(e.attr("href"))})},"invalid-children-evaluate":function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=arguments.length>2?arguments[2]:void 0,n=[],a=[]
if(r.children){for(var o=Eg(r.children);o.length;){var i,u=o.shift(),s=u.vChild,l=u.nested
if(t.divGroups&&!l&&wg(s)){if(!s.children)return
var c=Eg(s.children,!0)
o.push.apply(o,q(c))}else{var d=Fg(s,l,t)
d&&(a.includes(d)||a.push(d),1===(null==s||null===(i=s.actualNode)||void 0===i?void 0:i.nodeType)&&n.push(s.actualNode))}}return 0!==a.length&&(this.data({values:a.join(", ")}),this.relatedNodes(n),!0)}},"invalidrole-evaluate":function(e,t,r){var n=zf(r.attr("role"))
return!!n.every(function(e){return!ls(e.toLowerCase(),{allowAbstract:!0})})&&(this.data(n),!0)},"is-element-focusable-evaluate":function(e,t,r){return Yu(r)},"is-initiator-matches":Xg,"is-on-screen-evaluate":function(e){return Ji(e)},"is-visible-matches":function(e){return Ji(e)},"is-visible-on-screen-matches":function(e,t){return Ji(t)},"label-content-name-mismatch-evaluate":function(e,t,r){var n,a,o,i,u=null==t?void 0:t.pixelThreshold,s=null!==(n=null==t?void 0:t.occurrenceThreshold)&&void 0!==n?n:null==t?void 0:t.occuranceThreshold,l=es(e).toLowerCase(),c=vs(dl(r,{subtreeDescendant:!0,ignoreIconLigature:!0,pixelThreshold:u,occurrenceThreshold:s})).toLowerCase()
return!c||(Cl(l)<1||Cl(c)<1?void 0:(a=c,o=xg(l),i=xg(a),!(!o||!i)&&o.includes(i)))},"label-content-name-mismatch-matches":function(e,t){var r=Us(e)
return!!(r&&Jm("widget").includes(r)&&tD().includes(r)&&(vs(rs(t))||vs(ts(e)))&&vs(Xs(t)))},"label-matches":function(e,t){if("input"!==t.props.nodeName||!1===t.hasAttr("type"))return!0
var r=t.attr("type").toLowerCase()
return!1===["hidden","image","button","submit","reset"].includes(r)},"landmark-has-body-context-matches":function(e,t){return e.hasAttribute("role")||!xi(t,"article, aside, main, nav, section")},"landmark-is-top-level-evaluate":function(e){var t=Jm("landmark"),r=Wi(e),n=Us(e)
...
return a=a?a.toLowerCase():null,this.data({role:n,accessibleText:a}),this.relatedNodes([e]),!0},"landmark-unique-matches":function(e,t){return function(e){var t=Jm("landmark"),r=Us(e)
if(!r)return!1
var n=e.props.nodeName
return"section"===n||"form"===n?!!Fl(e):t.indexOf(r)>=0||"region"===r}(t)&&Qs(t)},"layout-table-matches":function(e){return!Lm(e)&&!Yu(e)},"link-in-text-block-evaluate":function(e,t){var r=t.requiredContrastRatio,n=t.allowSameColor
if(Sg(e))return!1
for(var a=Wi(e);a&&1===a.nodeType&&!Sg(a);)a=Wi(a)
if(a){this.relatedNodes([a])
var o=ag(e),i=ag(a),u=eg(e),s=eg(a),l=o&&i?Rg(o,i):void 0
if(l&&(l=Math.floor(100*l)/100),l&&l>=r)return!0
var c=u&&s?Rg(u,s):void 0
...
return(!r||"link"===r)&&!!t&&!!Ji(e)&&Zl(e)},"link-in-text-block-style-evaluate":function(e){if(Bg(e))return!1
for(var t=Wi(e);t&&1===t.nodeType&&!Bg(t);)t=Wi(t)
if(t){if(this.relatedNodes([t]),BD(e,t))return!0
...
return!!["presentation","none","list"].includes(o)||(o&&ls(o)?(this.data({messageKey:"roleNotValid"}),!1):["ul","ol","menu"].includes(a))}},"matches-definition-evaluate":function(e,t,r){return Is(r,t.matcher)},"meta-refresh-evaluate":function(e,t,r){var n=t||{},a=n.minDelay,o=n.maxDelay,i=V((r.attr("content")||"").trim().split(CD),1)[0]
...
return!(r&&0!==r.length||"combobox"===cs(t)&&cm(t,'input:not([type="hidden"])').length||lD(t,{popupRoles:["listbox"]}))},"no-negative-tabindex-matches":function(e,t){var r=Yh(t.attr("tabindex"))
...
r||c||i.push(t),r&&!c&&(u.push(t),s.includes(l)||s.push(l)),c&&(a=!0)}}else n=!0}),n||i.length?(this.relatedNodes(i),!0):!o&&!a&&(this.relatedNodes(u),this.data({messageKey:"roleNotValid",roles:s.join(", ")}),!0)},"p-as-heading-evaluate":function(e,t,r){var n=Array.from(e.parentNode.children),a=n.indexOf(e),o=(t=t||{}).margins||[],i=n.slice(a+1).find(function(e){return"P"===e.nodeName.toUpperCase()}),u=n.slice(0,a).reverse().find(function(e){return"P"===e.nodeName.toUpperCase()}),s=wD(e),l=i?wD(i):null,c=u?wD(u):null,d=t.passLength,p=t.failLength,f=e.textContent.trim().length,h=null==i?void 0:i.textContent.trim().length
if(f>h*d)return!0
if(!l||!ED(s,l,o))return!0
var m=xi(r,"blockquote")
return!!(m&&"BLOCKQUOTE"===m.nodeName.toUpperCase()||c&&!ED(s,c,o)||f>h*p)&&void 0},"p-as-heading-matches":function(e){var t=Array.from(e.parentNode.childNodes),r=e.textContent.trim()
...
if(Vh(n,o.node.ancestry)){e.result=o.result
...
return e}).filter(function(e,t,r){return r.indexOf(e)===t})}(t)}).includes(r)},"same-caption-summary-evaluate":function(e,t,r){if(void 0!==r.children){var n=r.attr("summary"),a=r.children.find(gD),o=!!a&&vs(dl(a))
return!(!o||!n)&&vs(n).toLowerCase()===vs(o).toLowerCase()}},"scope-value-evaluate":function(e,t){var r=e.getAttribute("scope").toLowerCase()
return-1!==t.values.indexOf(r)},"scrollable-region-focusable-matches":function(e,t){return void 0!==Ch(e,13)&&!1===lD(t)&&cm(t,"*").some(function(e){return Ll(e,!0,!0)})},"skip-link-evaluate":function(e){var t=Lu(e,"href")
...
var a,o=[],i=n,u=Q(Nu(r,n))
try{for(u.s();!(a=u.n()).done;){var s=a.value
if("widget"===Yl(s)&&Yu(s)){var l=null
try{l=su(r,s,n/2)}catch(e){if(e.message.startsWith("splitRects"))return void this.data({messageKey:"tooManyRects",closestOffset:0,minOffset:n})
throw e}null!==l&&(.05+(l=2*yg(l))>=n||(i=Math.min(i,l),o.push(s)))}}}catch(e){u.e(e)}finally{u.f()}return 0===o.length?(this.data({closestOffset:i,minOffset:n}),!0):(this.relatedNodes(o.map(function(e){return e.actualNode})),o.some(Qu)?(this.data({closestOffset:i,minOffset:n}),!Qu(r)&&void 0):void this.data({messageKey:"nonTabbableNeighbor",closestOffset:i,minOffset:n}))},"target-size-evaluate":function(e,t,r){var n=(null==t?void 0:t.minSize)||24,a=r.boundingClientRect
if(uu(10*n,a))return this.data({messageKey:"large",minSize:n}),!0
var o=uu.bind(null,n),i=Nu(r),u=function(e,t){return t.filter(function(t){return!mg(t,e)&&vg(e,t)})}(r,i),s=function(e,t){var r,n=[],a=[],o=Q(t)
try{for(o.s();!(r=o.n()).done;){var i=r.value
!vg(e,i)&&du(e,i)&&"none"!==Dg(i)&&(mg(e,i)?n.push(i):a.push(i))}}catch(e){o.e(e)}finally{o.f()}return{fullyObscuringElms:n,partialObscuringElms:a}}(r,i),l=s.fullyObscuringElms,c=s.partialObscuringElms
if(u.length&&(l.length||!o(a)))return this.data({minSize:n,messageKey:"contentOverflow"}),void this.relatedNodes(bg(u))
if(l.length)return this.relatedNodes(bg(l)),this.data({messageKey:"obscured"}),!0
var d=!Qu(r)&&void 0
if(!o(a))return this.data(z({minSize:n},gg(a))),d
var p=c.filter(function(e){return"widget"===Yl(e)&&Yu(e)})
if(!p.length)return this.data(z({minSize:n},gg(a))),!0
...
if(f){if(!o(f)){if(u.length)return this.data({minSize:n,messageKey:"contentOverflow"}),void this.relatedNodes(bg(u))
var h=p.every(Qu),m="partiallyObscured".concat(h?"":"NonTabbable")
return this.data(z({messageKey:m,minSize:n},gg(f))),this.relatedNodes(bg(p)),h?d:void 0}return this.data(z({minSize:n},gg(f||a))),this.relatedNodes(bg(p)),!0}this.data({minSize:n,messageKey:"tooManyRects"})},"td-has-header-evaluate":function(e){var t=[],r=Im(e),n=fs(e)
return r.forEach(function(e){zl(e)&&qm(e)&&!dD(e)&&(jm(e,n).some(function(e){return null!==e&&!!zl(e)})||t.push(e))}),!t.length||(this.relatedNodes(t),!1)},"td-headers-attr-evaluate":function(e){for(var t=[],r=[],n=[],a=0;a<e.rows.length;a++)for(var o=e.rows[a],i=0;i<o.cells.length;i++)t.push(o.cells[i])
...
var i=zf(o)
0!==i.length&&(e.getAttribute("id")&&(t=-1!==i.indexOf(e.getAttribute("id").trim())),a=i.some(function(e){return!u.includes(e)}),(t||a)&&n.push(e))}}),n.length>0?(this.relatedNodes(n),!1):!r.length||void this.relatedNodes(r)},"th-has-data-cells-evaluate":function(e){var t=Im(e),r=this,n=[]
...
Ds(e)&&(a=Um("down",t,o).find(function(t){return!Ds(t)&&jm(t,o).includes(e)})),!a&&gs(e)&&(a=Um("right",t,o).find(function(t){return!gs(t)&&jm(t,o).includes(e)})),a||r.relatedNodes(e),i=i&&a}}),!!i||void 0},"title-only-evaluate":function(e,t,r){var n=Nl(r),a=$s(r),o=r.attr("aria-describedby")
...
if("string"==typeof a){var o=Xf(a),i=t.value?!t.value.map(Xf).includes(o):!xm(o);(""!==o&&i||""!==a&&!vs(a))&&n.push(e+'="'+r.attr(e)+'"')}}),!(!n.length||"html"!==r.props.nodeName&&!Vl(r)||(this.data(n),0))},"valid-scrollable-semantics-evaluate":function(e,t){return function(e,t){var r=cs(e)
return r&&(Pg[r]||t.roles.includes(r))||!1}(e,t)||function(e){var t=e.nodeName.toUpperCase()
return Ig[t]||!1}(e)},"widget-not-inline-matches":function(e,t){return Gg.every(function(r){return r(e,t)})},"window-is-top-matches":function(e){return e.ownerDocument.defaultView.self===e.ownerDocument.defaultView.top},"xml-lang-mismatch-evaluate":function(e,t,r){return Xf(r.attr("lang"))===Xf(r.attr("xml:lang"))},"xml-lang-mismatch-matches":function(e){var t=Xf(e.getAttribute("lang")),r=Xf(e.getAttribute("xml:lang"))
return xm(t)&&xm(r)}},tv=ev,rv=function(e){this.id=e.id,this.data=null,this.relatedNodes=[],this.result=null}
function nv(e){if("string"==typeof e){if(tv[e])return tv[e]
...
return(Array.isArray(e)||"object"!==o(e))&&(e={value:e}),e}function ov(e){e&&(this.id=e.id,this.configure(e))}ov.prototype.enabled=!0,ov.prototype.run=function(e,t,r,n,a){var o=(t=t||{}).hasOwnProperty("enabled")?t.enabled:this.enabled,i=this.getOptions(t.options)
if(o){var u,s=new rv(this),l=ro(s,t,n,a)
try{u=this.evaluate.call(l,e.actualNode,i,e,r)}catch(t){return e&&e.actualNode&&(t.errorNode=ci.toSpec(e)),void a(t)}l.isAsync||(s.result=u,n(s))}else n(null)},ov.prototype.runSync=function(e,t,r){var n=(t=t||{}).enabled
if(!(void 0===n?this.enabled:n))return null
var a,o=this.getOptions(t.options),i=new rv(this),u=ro(i,t)
u.async=function(){throw new Error("Cannot run async check while in a synchronous run")}
try{a=this.evaluate.call(u,e.actualNode,o,e,r)}catch(t){throw e&&e.actualNode&&(t.errorNode=ci.toSpec(e)),t}return i.result=a,i},ov.prototype.configure=function(e){var t=this
e.evaluate&&!tv[e.evaluate]||(this._internalCheck=!0),e.hasOwnProperty("enabled")&&(this.enabled=e.enabled),e.hasOwnProperty("options")&&(this._internalCheck?this.options=av(e.options):this.options=e.options),["evaluate","after"].filter(function(t){return e.hasOwnProperty(t)}).forEach(function(r){return t[r]=nv(e[r])})},ov.prototype.getOptions=function(e){return this._internalCheck?gi(this.options,av(e||{})):e||this.options}
var iv=ov,uv=function(e){this.id=e.id,this.result=Jn.NA,this.pageLevel=e.pageLevel,this.impact=null,this.nodes=[]}
function sv(e,t){this._audit=t,this.id=e.id,this.selector=e.selector||"*",e.impact&&(Da(Jn.impact.includes(e.impact),"Impact ".concat(e.impact," is not a valid impact")),this.impact=e.impact),this.excludeHidden="boolean"!=typeof e.excludeHidden||e.excludeHidden,this.enabled="boolean"!=typeof e.enabled||e.enabled,this.pageLevel="boolean"==typeof e.pageLevel&&e.pageLevel,this.reviewOnFail="boolean"==typeof e.reviewOnFail&&e.reviewOnFail,this.any=e.any||[],this.all=e.all||[],this.none=e.none||[],this.tags=e.tags||[],this.preload=!!e.preload,this.actIds=e.actIds,e.matches&&(this.matches=nv(e.matches))}function lv(e){if(e.length){var t=!1,r={}
return e.forEach(function(e){var n=e.results.filter(function(e){return e})
r[e.type]=n,n.length&&(t=!0)}),t?r:null}}sv.prototype.matches=function(){return!0},sv.prototype.gather=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r="mark_gather_start_"+this.id,n="mark_gather_end_"+this.id,a="mark_isVisibleToScreenReaders_start_"+this.id,o="mark_isVisibleToScreenReaders_end_"+this.id
t.performanceTimer&&Qh.mark(r)
var i=mm(this.selector,e)
return this.excludeHidden&&(t.performanceTimer&&Qh.mark(a),i=i.filter(function(e){return Qs(e)}),t.performanceTimer&&(Qh.mark(o),Qh.measure("rule_"+this.id+"#gather_axe.utils.isVisibleToScreenReaders",a,o))),t.performanceTimer&&(Qh.mark(n),Qh.measure("rule_"+this.id+"#gather",r,n)),i},sv.prototype.runChecks=function(e,t,r,n,a,o){var i=this,u=xo()
this[e].forEach(function(e){var a=i._audit.checks[e.id||e],o=uh(a,i.id,r)
u.defer(function(e,r){a.run(t,o,n,e,r)})}),u.then(function(t){t=t.filter(function(e){return e}),a({type:e,results:t})}).catch(o)},sv.prototype.runChecksSync=function(e,t,r,n){var a=this,o=[]
return this[e].forEach(function(e){var i=a._audit.checks[e.id||e],u=uh(i,a.id,r)
o.push(i.runSync(t,u,n))}),{type:e,results:o=o.filter(function(e){return e})}},sv.prototype.run=function(e){var t=this,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=arguments.length>2?arguments[2]:void 0,a=arguments.length>3?arguments[3]:void 0
r.performanceTimer&&this._trackPerformance()
var o,i=xo(),s=new uv(this)
try{o=this.gatherAndMatchNodes(e,r)}catch(e){return void a(new u({cause:e,ruleId:this.id}))}r.performanceTimer&&this._logGatherPerformance(o),o.forEach(function(n){i.defer(function(a,o){var i=xo();["any","all","none"].forEach(function(a){i.defer(function(o,i){t.runChecks(a,n,r,e,o,i)})}),i.then(function(e){var r=lv(e)
r&&(r.node=new to(n),s.nodes.push(r),t.reviewOnFail&&(["any","all"].forEach(function(e){r[e].forEach(function(e){!1===e.result&&(e.result=void 0)})}),r.none.forEach(function(e){!0===e.result&&(e.result=void 0)}))),a()}).catch(function(e){return o(e)})})}),i.then(function(){r.performanceTimer&&t._logRulePerformance(),setTimeout(function(){n(s)},0)}).catch(function(e){r.performanceTimer&&t._logRulePerformance(),a(e)})},sv.prototype.runSync=function(e){var t=this,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
r.performanceTimer&&this._trackPerformance()
var n,a=new uv(this)
...
return e.pageLevel&&r.length&&(r=[r.reduce(function(e,r){if(e)return t.forEach(function(t){e[t].push.apply(e[t],r[t])}),e})]),r}(e),e},sv.prototype.configure=function(e){e.hasOwnProperty("selector")&&(this.selector=e.selector),e.hasOwnProperty("excludeHidden")&&(this.excludeHidden="boolean"!=typeof e.excludeHidden||e.excludeHidden),e.hasOwnProperty("enabled")&&(this.enabled="boolean"!=typeof e.enabled||e.enabled),e.hasOwnProperty("pageLevel")&&(this.pageLevel="boolean"==typeof e.pageLevel&&e.pageLevel),e.hasOwnProperty("reviewOnFail")&&(this.reviewOnFail="boolean"==typeof e.reviewOnFail&&e.reviewOnFail),e.hasOwnProperty("any")&&(this.any=e.any),e.hasOwnProperty("all")&&(this.all=e.all),e.hasOwnProperty("none")&&(this.none=e.none),e.hasOwnProperty("tags")&&(this.tags=e.tags),e.hasOwnProperty("actIds")&&(this.actIds=e.actIds),e.hasOwnProperty("matches")&&(this.matches=nv(e.matches)),e.impact&&(Da(Jn.impact.includes(e.impact),"Impact ".concat(e.impact," is not a valid impact")),this.impact=e.impact)}
var cv=de(Xn()),dv=/\{\{.+?\}\}/g,pv=W(function e(t){$(this,e),this.lang="en",this.defaultConfig=t,this.standards=us,this._init(),this._defaultLocale=null},[{key:"_setDefaultLocale",value:function(){if(!this._defaultLocale){for(var e={checks:{},rules:{},failureSummaries:{},incompleteFallbackMessage:"",lang:this.lang},t=Object.keys(this.data.checks),r=0;r<t.length;r++){var n=t[r],a=this.data.checks[n].messages,o=a.pass,i=a.fail,u=a.incomplete
...
if(e?(t=no(e)).commons=e.commons:t={},t.reporter=t.reporter||null,t.noHtml=t.noHtml||!1,!t.allowedOrigins){var r=hv()
...
"object"===o(t)&&(this.data.checks[e.id]=t,"object"===o(t.messages)&&Object.keys(t.messages).filter(function(e){return t.messages.hasOwnProperty(e)&&"string"==typeof t.messages[e]}).forEach(function(e){0===t.messages[e].indexOf("function")&&(t.messages[e]=new Function("return "+t.messages[e]+";")())})),this.checks[e.id]?this.checks[e.id].configure(e):this.checks[e.id]=new iv(e)}},{key:"run",value:function(e,t,r,n){this.normalizeOptions(t),to.setRunOptions(t),i._selectCache=[]
var a=function(e,t,r){return e.reduce(function(e,n){return pm(n,t,r)?n.preload?(e.later.push(n),e):(e.now.push(n),e):e},{now:[],later:[]})}(this.rules,e,t),o=a.now,u=a.later,s=xo()
o.forEach(function(r){s.defer(yv(r,e,t))})
var l=xo()
...
var c=xo()
u.forEach(function(r){var n=yv(r,e,t)
...
var a=e.data.rules[n.id];("string"!=typeof a.helpUrl||t&&a.helpUrl===Fv(t,n.id,r))&&(a.helpUrl=Fv(e,n.id,r))})}},{key:"resetRulesAndChecks",value:function(){this._init(),this._resetLocale()}}]),fv=pv
function hv(){return r.origin&&"null"!==r.origin?r.origin:r.location&&r.location.origin&&"null"!==r.location.origin?r.location.origin:void 0}function mv(e,t,r){var n,a
for(n=0,a=e.length;n<a;n++)t[r](e[n])}var Dv=function(e,t){var r=t.pass,n=t.fail
return"string"==typeof r&&dv.test(r)&&(r=cv.default.compile(r)),"string"==typeof n&&dv.test(n)&&(n=cv.default.compile(n)),z({},e,{messages:{pass:r||e.messages.pass,fail:n||e.messages.fail,incomplete:"object"===o(e.messages.incomplete)?z({},e.messages.incomplete,t.incomplete):t.incomplete}})},gv=function(e,t){var r=t.help,n=t.description
return"string"==typeof r&&dv.test(r)&&(r=cv.default.compile(r)),"string"==typeof n&&dv.test(n)&&(n=cv.default.compile(n)),z({},e,{help:r||e.help,description:n||e.description})},vv=function(e,t){var r=t.failureMessage
return"string"==typeof r&&dv.test(r)&&(r=cv.default.compile(r)),z({},e,{failureMessage:r||e.failureMessage})},bv=function(e,t){return"string"==typeof t&&dv.test(t)&&(t=cv.default.compile(t)),t||e}
function yv(e,t,r){return r.performanceTimer&&Qh.mark("mark_rule_start_"+e.id),function(n,a){e.run(t,r,function(e){n(e)},function(t){if(r.debug)a(t)
else{var o=Object.assign(new uv(e),{result:Jn.CANTTELL,description:"An error occured while running this rule",message:t.message,stack:t.stack,error:t,errorNode:t.errorNode})
n(o)}})}}function Fv(e,t,r){var n=e.brand,a=e.application,o=e.lang
return Jn.helpUrlBase+n+"/"+(r||i.version.substring(0,i.version.lastIndexOf(".")))+"/"+t+"?application="+encodeURIComponent(a)+(o&&"en"!==o?"&lang="+encodeURIComponent(o):"")}function wv(e){var t=r&&"Node"in r&&"NodeList"in r,n=!!a
...
n||(Xa.set("globalDocumentSet",!0),a=e.ownerDocument),t||(Xa.set("globalWindowSet",!0),r=a.defaultView)}}var Ev=function(){Xa.get("globalDocumentSet")&&(Xa.set("globalDocumentSet",!1),a=null),Xa.get("globalWindowSet")&&(Xa.set("globalWindowSet",!1),r=null),i._memoizedFns.forEach(function(e){return e.clear()}),Xa.clear(),i._tree=void 0,i._selectorData=void 0,i._selectCache=void 0}
function Cv(e,t,r,n){try{e=new yh(e),i._tree=e.flatTree,i._selectorData=Pa(e.flatTree)}catch(e){return Ev(),n(e)}var a=xo(),o=i._audit
t.performanceTimer&&Qh.auditStart(),e.frames.length&&!1!==t.iframes&&a.defer(function(r,n){mi(e,t,"rules",null,r,n)}),a.defer(function(r,n){o.run(e,t,r,n)}),a.then(function(a){try{t.performanceTimer&&Qh.auditEnd()
...
try{r(i,Ev)}catch(e){Ev(),ea(e)}}catch(e){Ev(),n(e)}}).catch(function(e){Ev(),n(e)})}function xv(e){this._run=e.run,this._collect=e.collect,this._registry={},e.commands.forEach(function(e){i._audit.registerCommand(e)})}function Av(e){var t,r,n,u=V(e,3),s=u[0],l=u[1],c=u[2],d=new TypeError("axe.run arguments are invalid")
...
var s=e&&e.options||{}
switch(e.command){case"rules":return Cv(u,s,function(e,t){e=ci.mapRawResults(e),n(e),t()},o)
case"cleanup-plugin":return Rm(n,o)
default:if(i._audit&&i._audit.commands&&i._audit.commands[e.command])return i._audit.commands[e.command](e,r)}}),ni.subscribe("axe.ping",function(e,t,r){r({axe:!0})})),xv.prototype.run=function(){return this._run.apply(this,arguments)},xv.prototype.collect=function(){return this._collect.apply(this,arguments)},xv.prototype.cleanup=function(e){var t=i.utils.queue(),r=this
Object.keys(this._registry).forEach(function(e){t.defer(function(t){r._registry[e].cleanup(t)})}),t.then(e)},xv.prototype.add=function(e){this._registry[e.id]=e}
var kv=function(){}
function Tv(e){var t=e.frames,r=e.frameSpec
return r?t.map(function(e){return ci.mergeSpecs(e,r)}):t}var Nv=function(e,t,r){if("function"==typeof t&&(r=t,t={}),!e||!Array.isArray(e))return r(e)
r(e.map(function(e){for(var t=z({},e),r=0,n=["passes","violations","incomplete","inapplicable"];r<n.length;r++){var a=n[r]
t[a]=ci.mapRawNodeResults(t[a])}return t}))},Bv={base:{Audit:fv,CheckResult:rv,Check:iv,Context:yh,RuleResult:uv,Rule:sv,metadataFunctionMap:tv},public:{reporters:_m},helpers:{failureSummary:Zf,incompleteFallbackMessage:Jf,processAggregate:th},utils:{setDefaultFrameMessenger:ti,cacheNodeSelectors:Wf,getNodesMatchingExpression:Uf,convertSelector:go},commons:{dom:{nativelyHidden:_i,displayHidden:Si,visibilityHidden:Oi,contentVisibiltyHidden:Mi,ariaHidden:Ii,opacityHidden:Pi,scrollHidden:ji,overflowHidden:qi,clipHidden:Li,areaHidden:zi,detailsHidden:Vi}}}
i._thisWillBeDeletedDoNotUse=Bv,i.constants=Jn,i.log=ea,i.AbstractVirtualNode=ra,i.SerialVirtualNode=Bm,i.VirtualNode=Lf,i._cache=Xa,i.imports=ic,i.cleanup=Rm,i.configure=function(e){var t=i._audit
...
if(s!==m||D<l||D===l&&g<c||s===m&&l===D&&c===g&&o&&o!==f)throw new Error("Configured version ".concat(r," is not compatible with current axe version ").concat(i.version))}if(e.reporter&&("function"==typeof e.reporter||Sm(e.reporter))&&(t.reporter=e.reporter),e.checks){if(!Array.isArray(e.checks))throw new TypeError("Checks property must be an array")
...
return{ruleId:e.id,description:t.description,help:t.help,helpUrl:t.helpUrl,tags:e.tags,actIds:e.actIds}})},i._load=function(e){i._audit=new fv(e)},i.plugins={},i.registerPlugin=function(e){i.plugins[e.id]=new xv(e)},i.hasReporter=Sm,i.getReporter=Om,i.addReporter=function(e,t,r){_m[e]=t,r&&(Nm=t)},i.reset=function(){var e=i._audit
if(!e)throw new Error("No audit configured")
e.resetRulesAndChecks(),Object.keys(is).forEach(function(e){is[e]=os[e]})},i._runRules=Cv,i.runVirtualRule=function(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}
r.reporter=r.reporter||i._audit.reporter||"v1",i._selectorData={},t instanceof ra||(t=new Bm(t))
var n=wh(e)
...
wv(t[0])
var n=Av(t),a=n.context,o=n.options,u=n.callback,s=void 0===u?kv:u,l=function(e){var t,r,n
return"function"==typeof Promise&&e===kv?t=new Promise(function(e,t){r=t,n=e}):(n=function(t){return e(null,t)},r=function(t){return e(t)}),{thenable:t,reject:r,resolve:n}}(s),c=l.thenable,d=l.resolve,p=l.reject
...
t(e.message)}(e,s)}return i._running=!0,o.performanceTimer&&Qh.start(),i._runRules(a,o,function(e,t){var r=function(e){i._running=!1,t()
try{p(e)}catch(e){i.log(e)}}
try{o.performanceTimer&&Qh.mark("reporterStart"),function(e,t,r,n){var a=Om(t.reporter)(e,t,r,n)
void 0!==a&&r(a)}(e,o,function(e){o.performanceTimer&&(Qh.mark("reporterEnd"),Qh.measure("reporter","reporterStart","reporterEnd"),Qh.logMeasures("reporter"),Qh.end()),i._running=!1,t()
try{d(e)}catch(e){i.log(e)}},r)}catch(e){r(e)}},function(e){o.performanceTimer&&Qh.end(),i._running=!1,s(e),p(e)}),c},i.setup=function(e){if(i._tree)throw new Error("Axe is already setup. Call `axe.teardown()` before calling `axe.setup` again.")
return e&&"object"===o(e.documentElement)&&"object"===o(e.defaultView)&&(e=e.documentElement),wv(e),i._tree=Yf(e),i._selectorData=Pa(i._tree),i._tree[0]},i.teardown=Ev,i.runPartial=function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r]
var n=Av(t),a=n.options,o=n.context
...
return ci.toSpec(t)})
return u.initiator&&(t=sh()),i._running=!1,Ev(),{results:e,frames:r,environmentData:t}}).catch(function(e){return i._running=!1,Ev(),Promise.reject(e)})},i.finishRun=function(e){var t,r,n,a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
a=no(a)
...
var u=hi(e)
return(u=i._audit.after(u,a)).forEach(sm),function(e,t){return new Promise(function(r,n){Om(t.reporter)(e,t,r,n)})}(u=u.map(da),z({environmentData:o},a))},i.commons=AD,i.utils=na,i.addReporter("na",function(e,t,r){console.warn('"na" reporter will be deprecated in axe v4.0. Use the "v2" reporter instead.'),"function"==typeof t&&(r=t,t={})
...
r({raw:e,env:t})})}),i.addReporter("raw",Nv),i.addReporter("v1",function(e,t,r){"function"==typeof t&&(r=t,t={})
